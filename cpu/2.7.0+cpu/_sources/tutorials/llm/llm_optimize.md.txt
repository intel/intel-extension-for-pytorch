...
For LLM fine-tuning, please check the [LLM fine-tuning tutorial](https://github.com/intel/intel-extension-for-pytorch/tree/release/2.7/examples/cpu/llm/fine-tuning).
...
Complete examples can be found at [the Example directory](https://github.com/intel/intel-extension-for-pytorch/tree/release/2.7/examples/cpu/llm/inference).
...
Check [LLM distributed inference examples](https://github.com/intel/intel-extension-for-pytorch/tree/release/2.7/examples/cpu/llm/inference/distributed) for complete codes.
