...
.. code:: shell
  ...
  $ wget https://raw.githubusercontent.com/intel/intel-extension-for-pytorch/v2.0.110+xpu/scripts/compile_bundle.sh
...
.. list-table::
   ...
   * - Version
     - cxx11 ABI
   * - 2.0.110+xpu
     - `libintel-ext-pt-cxx11-abi-2.0.110+xpu.run <https://intel-extension-for-pytorch.s3.amazonaws.com/libipex/xpu/libintel-ext-pt-cxx11-abi-2.0.110%2Bxpu.run>`_
