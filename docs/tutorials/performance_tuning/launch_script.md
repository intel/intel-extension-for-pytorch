...
Example script [resnet50.py](https://github.com/intel/intel-extension-for-pytorch/tree/v2.1.0+cpu/examples/cpu/inference/resnet50_general_inference_script.py) will be used in this guide.
