...
The _\<LLAMA3_MODEL_ID_OR_LOCAL_PATH\>_ in the below commands specifies the Llama 3 model you will run, which can be found from [HuggingFace Models](https://huggingface.co/models).
