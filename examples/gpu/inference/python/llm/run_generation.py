...
parser.add_argument("--num-beam", default=1, type=int, help="beam width")
...
model = model_class[0].from_pretrained(
    args.model_id, torch_dtype=amp_dtype, config=config, low_cpu_mem_usage=True, trust_remote_code=True
)
...
num_beams = 1 if args.greedy else args.num_beam
# generate args
