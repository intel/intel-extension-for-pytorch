...
# For platform not support flash attention
Run_llama3-8b_peft_singlecard() {
    ...
    python llama3_ft.py \
        ...
        --save_steps=100 \
        --logging_steps=1 \
        --save_total_limit=8 2>&1 | tee llama3-8b_ft_singlecard.log
}

Run_llama3-8b_peft_singlecard_flashattn() {
    ...
    python llama3_ft.py \
        ...
        --save_steps=500 \
        --logging_steps=1 \
        --save_total_limit=8 2>&1 | tee llama3-8b_ft_singlecard_flashattn.log
}
...
Run_llama3-8b_peft_fsdp() {
    ...
    accelerate launch --main_process_port "29800" --config_file "fsdp_config.yaml"  llama3_ft.py \
        ...
        --fsdp_transformer_layer_cls_to_wrap 'LlamaDecoderLayer' 2>&1 | tee llama3-8b_ft_fsdp.log
