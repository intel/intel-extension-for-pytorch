...
if [ $((${MODE} & 0x02)) -ne 0 ]; then
    ...
    if [ $((${MODE} & 0x04)) -ne 0 ]; then
        ...
        echo "python -m pip install https://intel-extension-for-pytorch.s3.amazonaws.com/ipex_dev/cpu/intel_extension_for_pytorch-2.6.0%2Bgit45b5d5a-cp310-cp310-linux_x86_64.whl" >> ${AUX_INSTALL_SCRIPT}
        ...
        python -m pip install https://intel-extension-for-pytorch.s3.amazonaws.com/ipex_dev/cpu/intel_extension_for_pytorch-2.6.0%2Bgit45b5d5a-cp310-cp310-linux_x86_64.whl
    else
