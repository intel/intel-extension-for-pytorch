...
parser = argparse.ArgumentParser("Bloom generation script (int8 path)", add_help=False)
parser.add_argument(
    "-m",
    "--model-id",
    type=str,
...
if args.benchmark:
    ...
    if args.prompt is not None:
        ...
        prompt = prompt_pool["bloom"]["8192"] * int(int(args.input_tokens) / 8192)
    elif args.input_tokens in prompt_pool["bloom"]:
