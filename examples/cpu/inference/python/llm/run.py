...
def main(args_in: Optional[List[str]] = None) -> None:
    ...
    parser.add_argument(
        "--gptq",
        action="store_true",
        help="Run GPTQ calibration to generate optimized INT4 weight for weight-only quantization. This is recommended for INT4 to minimize accuracy drop after quantization."
    )
    parser.add_argument(
        "--group-size",
        default=0,
