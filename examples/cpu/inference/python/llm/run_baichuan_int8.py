...
parser = argparse.ArgumentParser(
    "Baichuan generation script (int8 path)", add_help=False
)
parser.add_argument(
    "-m",
    "--model-id",
...
if args.benchmark:
    ...
    if args.prompt is not None:
        ...
        prompt = prompt_pool["baichuan"]["8192"] * int(int(args.input_tokens) / 8192)
    elif args.input_tokens in prompt_pool["baichuan"]:
        prompt = prompt_pool["baichuan"][args.input_tokens]
    else:
