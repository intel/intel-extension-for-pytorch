...
parser = argparse.ArgumentParser(
    "GPTBigCode generation script (int8 path)", add_help=False
)
parser.add_argument(
    "-m",
    "--model-id",
...
if args.benchmark:
    ...
    if args.prompt is not None:
        ...
        prompt = prompt_pool["gptbigcode"]["8192"] * int(int(args.input_tokens) / 8192)
    elif args.input_tokens in prompt_pool["gptbigcode"]:
        prompt = prompt_pool["gptbigcode"][args.input_tokens]
    else:
