...
# TODO: `TrainingArguments` users rely on it being fully mutable.
# In the future see if we can narrow this to a few keys:
...
class TrainingArguments:
    ...
    # optim (`str` or [`training_args.OptimizerNames`],
    # *optional*, defaults to `"adamw_torch_fused"` (for torch<2.1.0 `"adamw_torch"`):
    ...
    gradient_checkpointing_kwargs: Optional[dict] = field(
        default=None,
        metadata={
            "help": "Gradient checkpointing key word arguments such "
            "as `use_reentrant`. "
    ...
    include_num_input_tokens_seen: Optional[bool] = field(
        default=False,
        metadata={
            "help": "If set to `True`, will track the number of input tokens "
            "seen throughout training. (May be slower in distributed training)"
        },
    )
