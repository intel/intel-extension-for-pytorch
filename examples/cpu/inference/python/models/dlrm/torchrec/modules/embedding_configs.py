...
def pooling_type_to_pooling_mode(pooling_type):
    raise Exception(f"Not supported func")
...
def data_type_to_sparse_type(data_type: DataType):
    ...
    # else:
    raise ValueError(f"Not supported func")
