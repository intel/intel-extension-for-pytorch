...
def main() -> None:
    ...
    Then, run this script as follows:
        ...
        python materialize_synthetic_multihot_dataset.py \
            ...
            --num_embeddings_per_feature 40000000,39060,17295,7424,20265,3,7122,1543,63,\
                40000000,3067956,405282,10,2209,11938,155,4,976,14,40000000,40000000,40000000,590152,12973,108,36 \
