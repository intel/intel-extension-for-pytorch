...
def create_version_files(base_dir, version_sha, ipex_git_sha, torch_version, torch_git_sha):
    print('Building torch_ipex version: {}'.format(version_sha))
...
create_version_files(base_dir, version_sha, ipex_git_sha, torch_version, torch_git_sha)
