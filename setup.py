...
def create_version_files(base_dir, version, ipex_git_sha, torch_git_sha):
  ...
  py_version_path = os.path.join(base_dir, 'scripts', 'version.py')
  ...
  cpp_version_path = os.path.join(base_dir, 'torch_dpcpp', 'csrc', 'version.cpp')
  with open(cpp_version_path, 'w') as f:
    f.write('// Autogenerated file, do not edit!\n')
    f.write('#include "torch_dpcpp/csrc/version.h"\n\n')
