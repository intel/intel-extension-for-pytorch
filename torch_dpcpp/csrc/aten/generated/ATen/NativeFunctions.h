...
CAFFE2_API Tensor & _acos__sycl(Tensor & self);
...
CAFFE2_API Tensor & _acos_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & arange_sycl_out(Tensor & out, Scalar start, Scalar end, Scalar step=1);
...
CAFFE2_API Tensor & _asin__sycl(Tensor & self);
...
CAFFE2_API Tensor & _asin_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _atan__sycl(Tensor & self);
...
CAFFE2_API Tensor & _atan_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor baddbmm_dpcpp(const Tensor & self, const Tensor & batch1, const Tensor & batch2, Scalar beta=1, Scalar alpha=1);
...
CAFFE2_API Tensor & baddbmm__dpcpp(Tensor & self, const Tensor & batch1, const Tensor & batch2, Scalar beta=1, Scalar alpha=1);
...
CAFFE2_API Tensor & baddbmm_out_dpcpp(Tensor & out, const Tensor & self, const Tensor & batch1, const Tensor & batch2, Scalar beta=1, Scalar alpha=1);
...
CAFFE2_API Tensor & bernoulli_tensor_sycl_(Tensor & self, const Tensor & p, Generator * generator=nullptr);
...
CAFFE2_API Tensor & bernoulli_scalar_sycl_(Tensor & self, double p=0.5, Generator * generator=nullptr);
...
CAFFE2_API Tensor bmm_dpcpp(const Tensor & self, const Tensor & mat2);
...
CAFFE2_API Tensor & bmm_out_dpcpp(Tensor & out, const Tensor & self, const Tensor & mat2);
...
CAFFE2_API Tensor & _ceil__sycl(Tensor & self);
...
CAFFE2_API Tensor & _ceil_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _clamp__sycl(Tensor & self, c10::optional<Scalar> min=c10::nullopt, c10::optional<Scalar> max=c10::nullopt);
...
CAFFE2_API Tensor & _clamp_out_sycl(Tensor & out, const Tensor & self, c10::optional<Scalar> min=c10::nullopt, c10::optional<Scalar> max=c10::nullopt);
...
CAFFE2_API Tensor & _clamp_max__sycl(Tensor & self, Scalar max);
...
CAFFE2_API Tensor & _clamp_max_out_sycl(Tensor & out, const Tensor & self, Scalar max);
...
CAFFE2_API Tensor & _clamp_min__sycl(Tensor & self, Scalar min);
...
CAFFE2_API Tensor & _clamp_min_out_sycl(Tensor & out, const Tensor & self, Scalar min);
CAFFE2_API bool cudnn_is_acceptable(const Tensor & self);
CAFFE2_API bool sycl_is_acceptable(const Tensor & self);
...
CAFFE2_API Tensor & _cosh__sycl(Tensor & self);
...
CAFFE2_API Tensor & _cosh_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor embedding_dense_backward_sycl(const Tensor & grad_output, const Tensor & indices, int64_t num_weights, int64_t padding_idx, bool scale_grad_by_freq);
...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor,Tensor> _embedding_bag_sycl(const Tensor & weight, const Tensor & indices, const Tensor & offsets, bool scale_grad_by_freq=false, int64_t mode=0, bool sparse=false, const Tensor & per_sample_weights={});
...
CAFFE2_API Tensor empty_sycl(IntArrayRef size, const TensorOptions & options={}, c10::optional<MemoryFormat> memory_format=c10::nullopt);
...
CAFFE2_API Tensor & resize_sycl_(Tensor & self, IntArrayRef size);
...
CAFFE2_API Tensor & _erfc__sycl(Tensor & self);
...
CAFFE2_API Tensor & _expm1__sycl(Tensor & self);
...
CAFFE2_API Tensor & _expm1_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & eye_out_sycl(Tensor & out, int64_t n);
...
CAFFE2_API Tensor & eye_out_sycl(Tensor & out, int64_t n, int64_t m);
...
CAFFE2_API Tensor & _floor__sycl(Tensor & self);
...
CAFFE2_API Tensor & _floor_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _log10__sycl(Tensor & self);
...
CAFFE2_API Tensor & _log10_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _log1p__sycl(Tensor & self);
...
CAFFE2_API Tensor & _log1p_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _log2__sycl(Tensor & self);
...
CAFFE2_API Tensor & _log2_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & logspace_sycl_out(Tensor & out, Scalar start, Scalar end, int64_t steps=100, double base=10.0);
...
CAFFE2_API Tensor log_softmax_sycl(const Tensor & self, int64_t dim, bool half_to_float);
...
CAFFE2_API Tensor log_softmax_backward_sycl(const Tensor & grad_output, const Tensor & output, int64_t dim, const Tensor & self);
...
CAFFE2_API Tensor mkldnn_convolution_forward(const Tensor & self, const Tensor & weight, const Tensor & bias, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups);
...
CAFFE2_API Tensor sycl_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups);
CAFFE2_API Tensor sycl_convolution_backward_input(IntArrayRef self_size, const Tensor & grad_output, const Tensor & weight, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool bias_defined);
CAFFE2_API std::tuple<Tensor,Tensor> sycl_convolution_backward_weights(IntArrayRef weight_size, const Tensor & grad_output, const Tensor & self, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool bias_defined);
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> sycl_convolution_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, std::array<bool,3> output_mask);
...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> sycl_batch_norm(const Tensor & input, const Tensor & weight, const Tensor & bias, const Tensor & running_mean, const Tensor & running_var, bool training, double momentum, double eps);
...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> sycl_batch_norm_backward(const Tensor & grad_out, const Tensor & input, const Tensor & weight, const Tensor & running_mean, const Tensor & running_var, const Tensor & save_mean, const Tensor & save_invstd, bool train, double eps, std::array<bool,3> output_mask);
...
CAFFE2_API Tensor & range_sycl_out(Tensor & out, Scalar start, Scalar end, Scalar step=1);
...
CAFFE2_API Tensor repeat_interleave_dpcpp(const Tensor & repeats);
...
CAFFE2_API Tensor & _round__sycl(Tensor & self);
...
CAFFE2_API Tensor & _round_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _rsqrt__sycl(Tensor & self);
...
CAFFE2_API Tensor & _rsqrt_out_sycl(Tensor & out, const Tensor & self);
#ifdef BUILD_NAMEDTENSOR
...
CAFFE2_API Tensor & _sinh__sycl(Tensor & self);
...
CAFFE2_API Tensor & _sinh_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor softmax_sycl(const Tensor & self, int64_t dim, bool half_to_float);
...
CAFFE2_API Tensor softmax_backward_sycl(const Tensor & grad_output, const Tensor & output, int64_t dim, const Tensor & self);
...
CAFFE2_API Tensor & _sqrt__sycl(Tensor & self);
...
CAFFE2_API Tensor & _sqrt_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _tanh__sycl(Tensor & self);
...
CAFFE2_API Tensor & _tanh_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor roll_sycl(const Tensor & self, IntArrayRef shifts, IntArrayRef dims={});
...
CAFFE2_API Tensor & _trunc__sycl(Tensor & self);
...
CAFFE2_API Tensor & _trunc_out_sycl(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor _s_where_sycl(const Tensor & condition, const Tensor & self, const Tensor & other);
...
CAFFE2_API Tensor & resize_as_sycl_(Tensor & self, const Tensor & the_template);
...
CAFFE2_API Scalar _local_scalar_dense_sycl(const Tensor & self);
...
CAFFE2_API Tensor & masked_fill__sycl(Tensor & self, const Tensor & mask, Scalar value);
...
CAFFE2_API Tensor & masked_fill__sycl(Tensor & self, const Tensor & mask, const Tensor & value);
...
CAFFE2_API Tensor & masked_scatter__sycl(Tensor & self, const Tensor & mask, const Tensor & source);
...
CAFFE2_API Tensor & tril_sycl_(Tensor & self, int64_t diagonal=0);
CAFFE2_API Tensor & triu_cpu_(Tensor & self, int64_t diagonal=0);
CAFFE2_API Tensor & triu_cuda_(Tensor & self, int64_t diagonal=0);
CAFFE2_API Tensor & triu_sycl_(Tensor & self, int64_t diagonal=0);
...
CAFFE2_API Tensor & triu_sycl_out(Tensor & out, const Tensor & self, int64_t diagonal=0);
...
CAFFE2_API Tensor & tril_sycl_out(Tensor & out, const Tensor & self, int64_t diagonal=0);
...
CAFFE2_API Tensor tril_indices_sycl(int64_t row, int64_t col, int64_t offset=0, const TensorOptions & options=at::kLong);
...
CAFFE2_API Tensor triu_indices_sycl(int64_t row, int64_t col, int64_t offset=0, const TensorOptions & options=at::kLong);
...
CAFFE2_API Tensor & ne_scalar_out_sycl(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & ne_out_sycl(Tensor & out, const Tensor & self, const Tensor & other);
...
CAFFE2_API Tensor & eq_scalar_out_sycl(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & eq_out_sycl(Tensor & out, const Tensor & self, const Tensor & other);
...
CAFFE2_API Tensor & ge_scalar_out_sycl(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & ge_out_sycl(Tensor & out, const Tensor & self, const Tensor & other);
...
CAFFE2_API Tensor & le_scalar_out_sycl(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & le_out_sycl(Tensor & out, const Tensor & self, const Tensor & other);
...
CAFFE2_API Tensor & gt_scalar_out_sycl(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & gt_out_sycl(Tensor & out, const Tensor & self, const Tensor & other);
...
CAFFE2_API Tensor & lt_scalar_out_sycl(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & lt_out_sycl(Tensor & out, const Tensor & self, const Tensor & other);
...
CAFFE2_API Tensor & masked_select_out_sycl(Tensor & out, const Tensor & self, const Tensor & mask);
...
CAFFE2_API Tensor masked_select_sycl(const Tensor & self, const Tensor & mask);
...
CAFFE2_API Tensor & gather_out_sycl(Tensor & out, const Tensor & self, int64_t dim, const Tensor & index, bool sparse_grad=false);
...
CAFFE2_API Tensor gather_sycl(const Tensor & self, int64_t dim, const Tensor & index, bool sparse_grad=false);
...
CAFFE2_API Tensor median_sycl(const Tensor & self);
...
CAFFE2_API Tensor & adaptive_avg_pool2d_out_sycl(Tensor & out, const Tensor & self, IntArrayRef output_size);
...
CAFFE2_API Tensor adaptive_avg_pool2d_sycl(const Tensor & self, IntArrayRef output_size);
...
CAFFE2_API Tensor adaptive_avg_pool2d_backward_sycl(const Tensor & grad_output, const Tensor & self);
...
CAFFE2_API Tensor & avg_pool2d_out_sycl(Tensor & out, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, bool ceil_mode=false, bool count_include_pad=true, c10::optional<int64_t> divisor_override=c10::nullopt);
...
CAFFE2_API Tensor avg_pool2d_sycl(const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, bool ceil_mode=false, bool count_include_pad=true, c10::optional<int64_t> divisor_override=c10::nullopt);
...
CAFFE2_API Tensor & avg_pool2d_backward_out_sycl(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, bool ceil_mode, bool count_include_pad, c10::optional<int64_t> divisor_override);
...
CAFFE2_API Tensor avg_pool2d_backward_sycl(const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, bool ceil_mode, bool count_include_pad, c10::optional<int64_t> divisor_override);
...
CAFFE2_API std::tuple<Tensor &,Tensor &> max_pool2d_with_indices_out_sycl(Tensor & out, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, IntArrayRef dilation=1, bool ceil_mode=false);
...
CAFFE2_API std::tuple<Tensor,Tensor> max_pool2d_with_indices_sycl(const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, IntArrayRef dilation=1, bool ceil_mode=false);
...
CAFFE2_API Tensor & max_pool2d_with_indices_backward_out_sycl(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode, const Tensor & indices);
...
CAFFE2_API Tensor max_pool2d_with_indices_backward_sycl(const Tensor & grad_output, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode, const Tensor & indices);
...
CAFFE2_API Tensor & upsample_nearest2d_out_sycl(Tensor & out, const Tensor & self, IntArrayRef output_size);
...
CAFFE2_API Tensor upsample_nearest2d_sycl(const Tensor & self, IntArrayRef output_size);
...
CAFFE2_API Tensor & upsample_nearest2d_backward_out_sycl(Tensor & grad_input, const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size);
...
CAFFE2_API Tensor upsample_nearest2d_backward_sycl(const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size);
