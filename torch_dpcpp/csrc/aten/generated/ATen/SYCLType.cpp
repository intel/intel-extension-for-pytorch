...
static auto& registerer = globalATenDispatch()
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::abs_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::abs_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::abs.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::abs_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::acos_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::acos_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::acos.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::acos_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::add.Tensor(Tensor self, Tensor other, *, Scalar alpha=1) -> Tensor", &SYCLType::add)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::add_.Tensor(Tensor(a!) self, Tensor other, *, Scalar alpha=1) -> Tensor(a!)", &SYCLType::add_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::add.out(Tensor self, Tensor other, *, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", &SYCLType::add_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::addmv(Tensor self, Tensor mat, Tensor vec, *, Scalar beta=1, Scalar alpha=1) -> Tensor", &SYCLType::addmv)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::addmv_(Tensor(a!) self, Tensor mat, Tensor vec, *, Scalar beta=1, Scalar alpha=1) -> Tensor(a!)", &SYCLType::addmv_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::addmv.out(Tensor self, Tensor mat, Tensor vec, *, Scalar beta=1, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", &SYCLType::addmv_out)
  .registerOp<Tensor & (Tensor &, Scalar, Scalar, Scalar)>(Backend::SYCL, "aten::arange.start_out(Scalar start, Scalar end, Scalar step=1, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::arange_out)
  .registerOp<Tensor (const Tensor &, IntArrayRef, IntArrayRef, c10::optional<int64_t>)>(Backend::SYCL, "aten::as_strided(Tensor(a) self, int[] size, int[] stride, int? storage_offset=None) -> Tensor(a)", &SYCLType::as_strided)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::asin_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::asin_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::asin.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::asin_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::atan_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::atan_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::atan.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::atan_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::baddbmm(Tensor self, Tensor batch1, Tensor batch2, *, Scalar beta=1, Scalar alpha=1) -> Tensor", &SYCLType::baddbmm)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::baddbmm_(Tensor(a!) self, Tensor batch1, Tensor batch2, *, Scalar beta=1, Scalar alpha=1) -> Tensor(a!)", &SYCLType::baddbmm_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::baddbmm.out(Tensor self, Tensor batch1, Tensor batch2, *, Scalar beta=1, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", &SYCLType::baddbmm_out)
  .registerOp<Tensor & (Tensor &, const Tensor &, Generator *)>(Backend::SYCL, "aten::bernoulli_.Tensor(Tensor(a!) self, Tensor p, *, Generator? generator=None) -> Tensor(a!)", &SYCLType::bernoulli_)
  .registerOp<Tensor & (Tensor &, double, Generator *)>(Backend::SYCL, "aten::bernoulli_.float(Tensor(a!) self, float p=0.5, *, Generator? generator=None) -> Tensor(a!)", &SYCLType::bernoulli_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::bitwise_not.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::bitwise_not_out)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::logical_not.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::logical_not_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::bmm(Tensor self, Tensor mat2) -> Tensor", &SYCLType::bmm)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::bmm.out(Tensor self, Tensor mat2, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::bmm_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::ceil_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::ceil_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::ceil.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::ceil_out)
  .registerOp<Tensor & (Tensor &, c10::optional<Scalar>, c10::optional<Scalar>)>(Backend::SYCL, "aten::clamp_(Tensor(a!) self, Scalar? min=None, Scalar? max=None) -> Tensor(a!)", &SYCLType::clamp_)
  .registerOp<Tensor & (Tensor &, const Tensor &, c10::optional<Scalar>, c10::optional<Scalar>)>(Backend::SYCL, "aten::clamp.out(Tensor self, Scalar? min=None, Scalar? max=None, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::clamp_out)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::clamp_max_(Tensor(a!) self, Scalar max) -> Tensor(a!)", &SYCLType::clamp_max_)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::clamp_max.out(Tensor self, Scalar max, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::clamp_max_out)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::clamp_min_(Tensor(a!) self, Scalar min) -> Tensor(a!)", &SYCLType::clamp_min_)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::clamp_min.out(Tensor self, Scalar min, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::clamp_min_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::cos_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::cos_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::cos.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::cos_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::cosh_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::cosh_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::cosh.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::cosh_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, int64_t, int64_t, bool)>(Backend::SYCL, "aten::embedding_dense_backward(Tensor grad_output, Tensor indices, int num_weights, int padding_idx, bool scale_grad_by_freq) -> Tensor", &SYCLType::embedding_dense_backward)
  .registerOp<std::tuple<Tensor,Tensor,Tensor,Tensor> (const Tensor &, const Tensor &, const Tensor &, bool, int64_t, bool, const Tensor &)>(Backend::SYCL, "aten::_embedding_bag(Tensor weight, Tensor indices, Tensor offsets, bool scale_grad_by_freq=False, int mode=0, bool sparse=False, Tensor? per_sample_weights=None) -> (Tensor, Tensor, Tensor, Tensor)", &SYCLType::_embedding_bag)
  .registerOp<Tensor (IntArrayRef, const TensorOptions &, c10::optional<MemoryFormat>)>(Backend::SYCL, "aten::empty.memory_format(int[] size, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, MemoryFormat? memory_format=None) -> Tensor", &SYCLType::empty)
  .registerOp<Tensor & (Tensor &, IntArrayRef)>(Backend::SYCL, "aten::resize_(Tensor(a!) self, int[] size) -> Tensor(a!)", &SYCLType::resize_)
  .registerOp<Tensor (IntArrayRef, IntArrayRef, const TensorOptions &)>(Backend::SYCL, "aten::empty_strided(int[] size, int[] stride, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor", &SYCLType::empty_strided)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::erf_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::erf_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::erf.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::erf_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::erfc_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::erfc_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::erfc.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::erfc_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::exp_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::exp_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::exp.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::exp_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::expm1_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::expm1_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::expm1.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::expm1_out)
  .registerOp<Tensor & (Tensor &, int64_t)>(Backend::SYCL, "aten::eye.out(int n, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::eye_out)
  .registerOp<Tensor & (Tensor &, int64_t, int64_t)>(Backend::SYCL, "aten::eye.m_out(int n, int m, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::eye_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::floor_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::floor_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::floor.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::floor_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::ger(Tensor self, Tensor vec2) -> Tensor", &SYCLType::ger)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::ger.out(Tensor self, Tensor vec2, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::ger_out)
  .registerOp<Tensor & (Tensor &, Scalar, Scalar, int64_t)>(Backend::SYCL, "aten::linspace.out(Scalar start, Scalar end, int steps=100, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::linspace_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::log_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::log_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::log.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::log_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::log10_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::log10_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::log10.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::log10_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::log1p_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::log1p_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::log1p.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::log1p_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::log2_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::log2_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::log2.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::log2_out)
  .registerOp<Tensor & (Tensor &, Scalar, Scalar, int64_t, double)>(Backend::SYCL, "aten::logspace.out(Scalar start, Scalar end, int steps=100, float base=10.0, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::logspace_out)
  .registerOp<Tensor (const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_log_softmax(Tensor self, int dim, bool half_to_float) -> Tensor", &SYCLType::_log_softmax)
  .registerOp<Tensor (const Tensor &, const Tensor &, int64_t, const Tensor &)>(Backend::SYCL, "aten::_log_softmax_backward_data(Tensor grad_output, Tensor output, int dim, Tensor self) -> Tensor", &SYCLType::_log_softmax_backward_data)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::mm(Tensor self, Tensor mat2) -> Tensor", &SYCLType::mm)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::mm.out(Tensor self, Tensor mat2, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::mm_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::mul.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::mul)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::mul_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::mul_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::mul.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::mul_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::mv(Tensor self, Tensor vec) -> Tensor", &SYCLType::mv)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::mv.out(Tensor self, Tensor vec, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::mv_out)
  .registerOp<Tensor (const Tensor &, int64_t, int64_t, int64_t)>(Backend::SYCL, "aten::narrow_copy(Tensor self, int dim, int start, int length) -> Tensor", &SYCLType::narrow_copy)
  .registerOp<std::tuple<Tensor,Tensor,Tensor> (const Tensor &, const Tensor &, const Tensor &, const Tensor &, const Tensor &, bool, double, double)>(Backend::SYCL, "aten::native_batch_norm(Tensor input, Tensor? weight, Tensor? bias, Tensor? running_mean, Tensor? running_var, bool training, float momentum, float eps) -> (Tensor, Tensor, Tensor)", &SYCLType::native_batch_norm)
  ...
  .registerOp<Tensor & (Tensor &, Scalar, Scalar, Scalar)>(Backend::SYCL, "aten::range.out(Scalar start, Scalar end, Scalar step=1, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::range_out)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::neg.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::neg_out)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::repeat_interleave.Tensor(Tensor repeats) -> Tensor", &SYCLType::repeat_interleave)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::round_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::round_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::round.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::round_out)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::relu(Tensor self) -> Tensor", &SYCLType::relu)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::relu_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::relu_)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::rsqrt_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::rsqrt_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::rsqrt.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::rsqrt_out)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::sigmoid(Tensor self) -> Tensor", &SYCLType::sigmoid)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::sigmoid.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::sigmoid_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::sin_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::sin_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::sin.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::sin_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::sinh_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::sinh_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::sinh.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::sinh_out)
  .registerOp<Tensor (const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_softmax(Tensor self, int dim, bool half_to_float) -> Tensor", &SYCLType::_softmax)
  .registerOp<Tensor (const Tensor &, const Tensor &, int64_t, const Tensor &)>(Backend::SYCL, "aten::_softmax_backward_data(Tensor grad_output, Tensor output, int dim, Tensor self) -> Tensor", &SYCLType::_softmax_backward_data)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::sqrt_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::sqrt_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::sqrt.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::sqrt_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::tan_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::tan_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::tan.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::tan_out)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::tanh_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::tanh_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::tanh.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::tanh_out)
  .registerOp<Tensor (const Tensor &, IntArrayRef, IntArrayRef)>(Backend::SYCL, "aten::roll(Tensor self, int[1] shifts, int[1] dims=[]) -> Tensor", &SYCLType::roll)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::trunc_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::trunc_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::trunc.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::trunc_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::_s_where(Tensor condition, Tensor self, Tensor other) -> Tensor", &SYCLType::_s_where)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::clone(Tensor self) -> Tensor", &SYCLType::clone)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::resize_as_(Tensor(a!) self, Tensor the_template) -> Tensor(a!)", &SYCLType::resize_as_)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::pow.Tensor_Scalar_out(Tensor self, Scalar exponent, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::pow_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::pow.Tensor_Scalar(Tensor self, Scalar exponent) -> Tensor", &SYCLType::pow)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::zero_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::zero_)
  .registerOp<Scalar (const Tensor &)>(Backend::SYCL, "aten::_local_scalar_dense(Tensor self) -> Scalar", &SYCLType::_local_scalar_dense)
  .registerOp<Tensor & (Tensor &, Storage)>(Backend::SYCL, "aten::set_.source_Storage(Tensor(a!) self, Storage source) -> Tensor(a!)", &SYCLType::set_)
  .registerOp<Tensor & (Tensor &, Storage, int64_t, IntArrayRef, IntArrayRef)>(Backend::SYCL, "aten::set_.source_Storage_storage_offset(Tensor(a!) self, Storage source, int storage_offset, int[] size, int[] stride=[]) -> Tensor(a!)", &SYCLType::set_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::set_.source_Tensor(Tensor(a!) self, Tensor source) -> Tensor(a!)", &SYCLType::set_)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::set_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::set_)
  .registerOp<bool (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::is_set_to(Tensor self, Tensor tensor) -> bool", &SYCLType::is_set_to)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::masked_fill_.Scalar(Tensor(a!) self, Tensor mask, Scalar value) -> Tensor(a!)", &SYCLType::masked_fill_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::masked_fill_.Tensor(Tensor(a!) self, Tensor mask, Tensor value) -> Tensor(a!)", &SYCLType::masked_fill_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::masked_scatter_(Tensor(a!) self, Tensor mask, Tensor source) -> Tensor(a!)", &SYCLType::masked_scatter_)
  .registerOp<Tensor (const Tensor &, IntArrayRef)>(Backend::SYCL, "aten::view(Tensor(a) self, int[] size) -> Tensor(a)", &SYCLType::view)
  .registerOp<Tensor & (Tensor &, int64_t, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::index_add_(Tensor(a!) self, int dim, Tensor index, Tensor source) -> Tensor(a!)", &SYCLType::index_add_)
  .registerOp<Tensor & (Tensor &, int64_t, const Tensor &, Scalar)>(Backend::SYCL, "aten::index_fill_.Scalar(Tensor(a!) self, int dim, Tensor index, Scalar value) -> Tensor(a!)", &SYCLType::index_fill_)
  .registerOp<Tensor & (Tensor &, int64_t, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::index_fill_.Tensor(Tensor(a!) self, int dim, Tensor index, Tensor value) -> Tensor(a!)", &SYCLType::index_fill_)
  .registerOp<Tensor & (Tensor &, int64_t, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::scatter_.src(Tensor(a!) self, int dim, Tensor index, Tensor src) -> Tensor(a!)", &SYCLType::scatter_)
  .registerOp<Tensor & (Tensor &, int64_t, const Tensor &, Scalar)>(Backend::SYCL, "aten::scatter_.value(Tensor(a!) self, int dim, Tensor index, Scalar value) -> Tensor(a!)", &SYCLType::scatter_)
  .registerOp<Tensor & (Tensor &, int64_t, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::scatter_add_(Tensor(a!) self, int dim, Tensor index, Tensor src) -> Tensor(a!)", &SYCLType::scatter_add_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::lt_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::lt_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::lt_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::lt_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::gt_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::gt_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::gt_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::gt_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::le_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::le_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::le_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::le_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::ge_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::ge_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::ge_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::ge_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::eq_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::eq_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::eq_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::eq_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::ne_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::ne_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::ne_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::ne_)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::__and__.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::__and__)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::__and__.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::__and__)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::__iand__.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::__iand__)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::__iand__.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::__iand__)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::__or__.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::__or__)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::__or__.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::__or__)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::__ior__.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::__ior__)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::__ior__.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::__ior__)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::__xor__.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::__xor__)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::__xor__.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::__xor__)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::__ixor__.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::__ixor__)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::__ixor__.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::__ixor__)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::__lshift__.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::__lshift__)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::__lshift__.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::__lshift__)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::__ilshift__.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::__ilshift__)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::__ilshift__.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::__ilshift__)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::__rshift__.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::__rshift__)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::__rshift__.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::__rshift__)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::__irshift__.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::__irshift__)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::__irshift__.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::__irshift__)
  .registerOp<Tensor & (Tensor &, int64_t)>(Backend::SYCL, "aten::tril_(Tensor(a!) self, int diagonal=0) -> Tensor(a!)", &SYCLType::tril_)
  .registerOp<Tensor & (Tensor &, int64_t)>(Backend::SYCL, "aten::triu_(Tensor(a!) self, int diagonal=0) -> Tensor(a!)", &SYCLType::triu_)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::digamma_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::digamma_)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::erfinv_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::erfinv_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::pow_.Scalar(Tensor(a!) self, Scalar exponent) -> Tensor(a!)", &SYCLType::pow_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::pow_.Tensor(Tensor(a!) self, Tensor exponent) -> Tensor(a!)", &SYCLType::pow_)
  .registerOp<Tensor & (Tensor &)>(Backend::SYCL, "aten::sign_(Tensor(a!) self) -> Tensor(a!)", &SYCLType::sign_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::fmod_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::fmod_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::fmod_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::fmod_)
  .registerOp<Tensor & (Tensor &, Scalar)>(Backend::SYCL, "aten::remainder_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", &SYCLType::remainder_)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::remainder_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)", &SYCLType::remainder_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::addbmm_(Tensor(a!) self, Tensor batch1, Tensor batch2, *, Scalar beta=1, Scalar alpha=1) -> Tensor(a!)", &SYCLType::addbmm_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::addbmm.out(Tensor self, Tensor batch1, Tensor batch2, *, Scalar beta=1, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", &SYCLType::addbmm_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::addbmm(Tensor self, Tensor batch1, Tensor batch2, *, Scalar beta=1, Scalar alpha=1) -> Tensor", &SYCLType::addbmm)
  .registerOp<Tensor & (Tensor &, double, double, Generator *)>(Backend::SYCL, "aten::normal_(Tensor(a!) self, float mean=0, float std=1, *, Generator? generator=None) -> Tensor(a!)", &SYCLType::normal_)
  .registerOp<Tensor & (Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::diag.out(Tensor self, int diagonal=0, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::diag_out)
  .registerOp<Tensor (const Tensor &, int64_t)>(Backend::SYCL, "aten::diag(Tensor self, int diagonal=0) -> Tensor", &SYCLType::diag)
  .registerOp<Tensor & (Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::triu.out(Tensor self, int diagonal=0, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::triu_out)
  .registerOp<Tensor & (Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::tril.out(Tensor self, int diagonal=0, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::tril_out)
  .registerOp<Tensor (int64_t, int64_t, int64_t, const TensorOptions &)>(Backend::SYCL, "aten::tril_indices(int row, int col, int offset=0, *, ScalarType? dtype=long, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor", &SYCLType::tril_indices)
  .registerOp<Tensor (int64_t, int64_t, int64_t, const TensorOptions &)>(Backend::SYCL, "aten::triu_indices(int row, int col, int offset=0, *, ScalarType? dtype=long, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor", &SYCLType::triu_indices)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::trace(Tensor self) -> Tensor", &SYCLType::trace)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::ne.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::ne_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::ne.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::ne)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::ne.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::ne_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::ne.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::ne)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::eq.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::eq_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::eq.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::eq)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::eq.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::eq_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::eq.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::eq)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::ge.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::ge_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::ge.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::ge)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::ge.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::ge_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::ge.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::ge)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::le.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::le_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::le.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::le)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::le.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::le_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::le.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::le)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::gt.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::gt_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::gt.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::gt)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::gt.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::gt_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::gt.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::gt)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::lt.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::lt_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::lt.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::lt)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::lt.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::lt_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::lt.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::lt)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::take.out(Tensor self, Tensor index, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::take_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::take(Tensor self, Tensor index) -> Tensor", &SYCLType::take)
  .registerOp<Tensor & (Tensor &, const Tensor &, int64_t, const Tensor &)>(Backend::SYCL, "aten::index_select.out(Tensor self, int dim, Tensor index, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::index_select_out)
  .registerOp<Tensor (const Tensor &, int64_t, const Tensor &)>(Backend::SYCL, "aten::index_select(Tensor self, int dim, Tensor index) -> Tensor", &SYCLType::index_select)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::masked_select.out(Tensor self, Tensor mask, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::masked_select_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::masked_select(Tensor self, Tensor mask) -> Tensor", &SYCLType::masked_select)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::nonzero.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::nonzero_out)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::nonzero(Tensor self) -> Tensor", &SYCLType::nonzero)
  .registerOp<Tensor & (Tensor &, const Tensor &, int64_t, const Tensor &, bool)>(Backend::SYCL, "aten::gather.out(Tensor self, int dim, Tensor index, *, bool sparse_grad=False, Tensor(a!) out) -> Tensor(a!)", &SYCLType::gather_out)
  .registerOp<Tensor (const Tensor &, int64_t, const Tensor &, bool)>(Backend::SYCL, "aten::gather(Tensor self, int dim, Tensor index, *, bool sparse_grad=False) -> Tensor", &SYCLType::gather)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::digamma(Tensor self) -> Tensor", &SYCLType::digamma)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::erfinv.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::erfinv_out)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::erfinv(Tensor self) -> Tensor", &SYCLType::erfinv)
  .registerOp<Tensor & (Tensor &, const Tensor &)>(Backend::SYCL, "aten::sign.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::sign_out)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::sign(Tensor self) -> Tensor", &SYCLType::sign)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::fmod.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::fmod_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::fmod.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::fmod)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::fmod.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::fmod_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::fmod.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::fmod)
  .registerOp<Tensor & (Tensor &, const Tensor &, Scalar)>(Backend::SYCL, "aten::remainder.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::remainder_out)
  .registerOp<Tensor (const Tensor &, Scalar)>(Backend::SYCL, "aten::remainder.Scalar(Tensor self, Scalar other) -> Tensor", &SYCLType::remainder)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::remainder.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::remainder_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::remainder.Tensor(Tensor self, Tensor other) -> Tensor", &SYCLType::remainder)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::min.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::min_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::min.other(Tensor self, Tensor other) -> Tensor", &SYCLType::min)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::min(Tensor self) -> Tensor", &SYCLType::min)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::max.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::max_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::max.other(Tensor self, Tensor other) -> Tensor", &SYCLType::max)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::max(Tensor self) -> Tensor", &SYCLType::max)
  .registerOp<Tensor (const Tensor &)>(Backend::SYCL, "aten::median(Tensor self) -> Tensor", &SYCLType::median)
  .registerOp<std::tuple<Tensor &,Tensor &> (Tensor &, Tensor &, const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::sort.values(Tensor self, int dim=-1, bool descending=False, *, Tensor(a!) values, Tensor(b!) indices) -> (Tensor(a!) values, Tensor(b!) indices)", &SYCLType::sort_out)
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::sort(Tensor self, int dim=-1, bool descending=False) -> (Tensor values, Tensor indices)", &SYCLType::sort)
  .registerOp<std::tuple<Tensor &,Tensor &> (Tensor &, Tensor &, const Tensor &, int64_t, int64_t, bool, bool)>(Backend::SYCL, "aten::topk.values(Tensor self, int k, int dim=-1, bool largest=True, bool sorted=True, *, Tensor(a!) values, Tensor(b!) indices) ->(Tensor(a!) values, Tensor(b!) indices)", &SYCLType::topk_out)
  .registerOp<Tensor (const Tensor &, int64_t, int64_t, int64_t)>(Backend::SYCL, "aten::unfold(Tensor(a) self, int dimension, int size, int step) -> Tensor(a)", &SYCLType::unfold)
  .registerOp<bool (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::equal(Tensor self, Tensor other) -> bool", &SYCLType::equal)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::pow.Tensor_Tensor_out(Tensor self, Tensor exponent, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::pow_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::pow.Tensor_Tensor(Tensor self, Tensor exponent) -> Tensor", &SYCLType::pow)
  .registerOp<Tensor & (Tensor &, Scalar, const Tensor &)>(Backend::SYCL, "aten::pow.Scalar_out(Scalar self, Tensor exponent, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::pow_out)
  .registerOp<Tensor (Scalar, const Tensor &)>(Backend::SYCL, "aten::pow.Scalar(Scalar self, Tensor exponent) -> Tensor", &SYCLType::pow)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::_addr(Tensor self, Tensor vec1, Tensor vec2, *, Scalar beta=1, Scalar alpha=1) -> Tensor", &SYCLType::_addr)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::_addr_(Tensor(a!) self, Tensor vec1, Tensor vec2, *, Scalar beta=1, Scalar alpha=1) -> Tensor(a!)", &SYCLType::_addr_)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::_addr.out(Tensor self, Tensor vec1, Tensor vec2, *, Scalar beta=1, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", &SYCLType::_addr_out)
  .registerOp<Tensor & (Tensor &, int64_t, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::_index_copy_(Tensor(a!) self, int dim, Tensor index, Tensor source) -> Tensor(a!)", &SYCLType::_index_copy_)
  .registerOp<Tensor (const Tensor &, int64_t)>(Backend::SYCL, "aten::_cumsum(Tensor self, int dim) -> Tensor", &SYCLType::_cumsum)
  .registerOp<Tensor & (Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::_cumsum.out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::_cumsum_out)
  .registerOp<Tensor (const Tensor &, int64_t)>(Backend::SYCL, "aten::_cumprod(Tensor self, int dim) -> Tensor", &SYCLType::_cumprod)
  .registerOp<Tensor & (Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::_cumprod.out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::_cumprod_out)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::_addmm.out(Tensor self, Tensor mat1, Tensor mat2, *, Scalar beta=1, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", &SYCLType::_addmm_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::_addmm(Tensor self, Tensor mat1, Tensor mat2, *, Scalar beta=1, Scalar alpha=1) -> Tensor", &SYCLType::_addmm)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(Backend::SYCL, "aten::_addmm_(Tensor(a!) self, Tensor mat1, Tensor mat2, *, Scalar beta=1, Scalar alpha=1) -> Tensor(a!)", &SYCLType::_addmm_)
  .registerOp<Tensor (TensorList, int64_t)>(Backend::SYCL, "aten::_cat(Tensor[] tensors, int dim=0) -> Tensor", &SYCLType::_cat)
  .registerOp<Tensor & (Tensor &, TensorList, int64_t)>(Backend::SYCL, "aten::_cat.out(Tensor[] tensors, int dim=0, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::_cat_out)
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_mode(Tensor self, int dim=-1, bool keepdim=False) -> (Tensor, Tensor)", &SYCLType::_mode)
  .registerOp<std::tuple<Tensor &,Tensor &> (Tensor &, Tensor &, const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_mode.values(Tensor self, int dim=-1, bool keepdim=False, *, Tensor(a!) values, Tensor(b!) indices) -> (Tensor(a!), Tensor(b!))", &SYCLType::_mode_out)
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_max(Tensor self, int dim, bool keepdim=False) -> (Tensor, Tensor)", &SYCLType::_max)
  .registerOp<std::tuple<Tensor &,Tensor &> (Tensor &, Tensor &, const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_max.max(Tensor self, int dim, bool keepdim=False, *, Tensor(a!) max, Tensor(b!) max_indices) -> (Tensor(a!), Tensor(b!))", &SYCLType::_max_out)
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_min(Tensor self, int dim, bool keepdim=False) -> (Tensor, Tensor)", &SYCLType::_min)
  .registerOp<std::tuple<Tensor &,Tensor &> (Tensor &, Tensor &, const Tensor &, int64_t, bool)>(Backend::SYCL, "aten::_min.min(Tensor self, int dim, bool keepdim=False, *, Tensor(a!) min, Tensor(b!) min_indices) -> (Tensor(a!), Tensor(b!))", &SYCLType::_min_out)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::binary_cross_entropy.out(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::binary_cross_entropy_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::binary_cross_entropy(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean) -> Tensor", &SYCLType::binary_cross_entropy)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::mse_loss.out(Tensor self, Tensor target, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::mse_loss_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, int64_t)>(Backend::SYCL, "aten::mse_loss(Tensor self, Tensor target, int reduction=Mean) -> Tensor", &SYCLType::mse_loss)
  ...
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, const Tensor &, const Tensor &, int64_t, int64_t)>(Backend::SYCL, "aten::nll_loss_forward(Tensor self, Tensor target, Tensor? weight, int reduction, int ignore_index) -> (Tensor output, Tensor total_weight)", &SYCLType::nll_loss_forward)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, const Tensor &, const Tensor &, int64_t, int64_t, const Tensor &)>(Backend::SYCL, "aten::nll_loss_backward.grad_input(Tensor grad_output, Tensor self, Tensor target, Tensor? weight, int reduction, int ignore_index, Tensor total_weight, *, Tensor(a!) grad_input) -> Tensor(a!)", &SYCLType::nll_loss_backward_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, const Tensor &, const Tensor &, int64_t, int64_t, const Tensor &)>(Backend::SYCL, "aten::nll_loss_backward(Tensor grad_output, Tensor self, Tensor target, Tensor? weight, int reduction, int ignore_index, Tensor total_weight) -> Tensor", &SYCLType::nll_loss_backward)
  .registerOp<Tensor & (Tensor &, const Tensor &, IntArrayRef)>(Backend::SYCL, "aten::adaptive_avg_pool2d.out(Tensor self, int[2] output_size, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::adaptive_avg_pool2d_out)
  .registerOp<Tensor (const Tensor &, IntArrayRef)>(Backend::SYCL, "aten::_adaptive_avg_pool2d(Tensor self, int[2] output_size) -> Tensor", &SYCLType::_adaptive_avg_pool2d)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::_adaptive_avg_pool2d_backward(Tensor grad_output, Tensor self) -> Tensor", &SYCLType::_adaptive_avg_pool2d_backward)
  ...
  .registerOp<Tensor (const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, bool, bool, c10::optional<int64_t>)>(Backend::SYCL, "aten::avg_pool2d(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, bool ceil_mode=False, bool count_include_pad=True, int? divisor_override=None) -> Tensor", &SYCLType::avg_pool2d)
  ...
  .registerOp<std::tuple<Tensor &,Tensor &> (Tensor &, Tensor &, const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, IntArrayRef, bool)>(Backend::SYCL, "aten::max_pool2d_with_indices.out(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False, *, Tensor(a!) out, Tensor(b!) indices) -> (Tensor(a!), Tensor(b!))", &SYCLType::max_pool2d_with_indices_out)
  .registerOp<std::tuple<Tensor,Tensor> (const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, IntArrayRef, bool)>(Backend::SYCL, "aten::max_pool2d_with_indices(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False) -> (Tensor, Tensor)", &SYCLType::max_pool2d_with_indices)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, IntArrayRef, bool, const Tensor &)>(Backend::SYCL, "aten::max_pool2d_with_indices_backward.grad_input(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, bool ceil_mode, Tensor indices, *, Tensor(a!) grad_input) -> Tensor(a!)", &SYCLType::max_pool2d_with_indices_backward_out)
  .registerOp<Tensor (const Tensor &, const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, IntArrayRef, bool, const Tensor &)>(Backend::SYCL, "aten::max_pool2d_with_indices_backward(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, bool ceil_mode, Tensor indices) -> Tensor", &SYCLType::max_pool2d_with_indices_backward)
  .registerOp<Tensor & (Tensor &, const Tensor &, IntArrayRef)>(Backend::SYCL, "aten::upsample_nearest2d.out(Tensor self, int[2] output_size, *, Tensor(a!) out) -> Tensor(a!)", &SYCLType::upsample_nearest2d_out)
  .registerOp<Tensor (const Tensor &, IntArrayRef)>(Backend::SYCL, "aten::upsample_nearest2d(Tensor self, int[2] output_size) -> Tensor", &SYCLType::upsample_nearest2d)
  .registerOp<Tensor & (Tensor &, const Tensor &, IntArrayRef, IntArrayRef)>(Backend::SYCL, "aten::upsample_nearest2d_backward.grad_input(Tensor grad_output, int[2] output_size, int[4] input_size, *, Tensor(a!) grad_input) -> Tensor(a!)", &SYCLType::upsample_nearest2d_backward_out)
  .registerOp<Tensor (const Tensor &, IntArrayRef, IntArrayRef)>(Backend::SYCL, "aten::upsample_nearest2d_backward(Tensor grad_output, int[2] output_size, int[4] input_size) -> Tensor", &SYCLType::upsample_nearest2d_backward)
  .registerOp<Tensor & (Tensor &, const Tensor &, const Tensor &)>(Backend::SYCL, "aten::tanh_backward.grad_input(Tensor grad_output, Tensor output, *, Tensor(a!) grad_input) -> Tensor(a!)", &SYCLType::tanh_backward_out)
  .registerOp<Tensor (const Tensor &, const Tensor &)>(Backend::SYCL, "aten::tanh_backward(Tensor grad_output, Tensor output) -> Tensor", &SYCLType::tanh_backward);
}
