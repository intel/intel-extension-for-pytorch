...
static inline bool sycl_is_acceptable(const Tensor & self);
...
static inline bool sycl_is_acceptable(const Tensor & self) {
#ifdef USE_STATIC_DISPATCH
    return TypeDefault::sycl_is_acceptable(self);
#else
    static auto table = globalATenDispatch().getOpTable("aten::sycl_is_acceptable(Tensor self) -> bool");
    return table->getOp<bool (const Tensor &)>(at::detail::infer_backend(self), at::detail::infer_is_variable(self))(self);
#endif
}
