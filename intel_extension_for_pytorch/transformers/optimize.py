...
def optimize_transformers(
    ...
    try:
        ...
        xpu_woq = False
        if device == "xpu" and woq:
            # optimize woq llm model generated by itres
            # no need to call convert_qmodel now, since the model has already been quantized
            xpu_woq = True
            print("[INFO] Optimize INT4 WOQ model!")
