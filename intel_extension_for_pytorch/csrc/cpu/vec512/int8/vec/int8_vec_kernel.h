...
static inline __attribute__((always_inline)) void scale_and_store_int8_128(
  ...
  auto in0_1_32i =
      _mm512_cvtepi8_epi32(_mm_loadu_si128((__m128i*)((int8_t*)in + 16)));
  auto in0_2_32i =
      _mm512_cvtepi8_epi32(_mm_loadu_si128((__m128i*)((int8_t*)in + 32)));
  auto in0_3_32i =
      _mm512_cvtepi8_epi32(_mm_loadu_si128((__m128i*)((int8_t*)in + 48)));
  auto in0_4_32i =
      _mm512_cvtepi8_epi32(_mm_loadu_si128((__m128i*)((int8_t*)in + 64)));
  auto in0_5_32i =
      _mm512_cvtepi8_epi32(_mm_loadu_si128((__m128i*)((int8_t*)in + 80)));
  auto in0_6_32i =
      _mm512_cvtepi8_epi32(_mm_loadu_si128((__m128i*)((int8_t*)in + 96)));
  auto in0_7_32i =
      _mm512_cvtepi8_epi32(_mm_loadu_si128((__m128i*)((int8_t*)in + 112)));
  ...
  _mm_storeu_si128(
      (__m128i*)((int8_t*)out + 16), _mm512_cvtsepi32_epi8(in0_1_32i));
  _mm_storeu_si128(
      (__m128i*)((int8_t*)out + 32), _mm512_cvtsepi32_epi8(in0_2_32i));
  _mm_storeu_si128(
      (__m128i*)((int8_t*)out + 48), _mm512_cvtsepi32_epi8(in0_3_32i));
  _mm_storeu_si128(
      (__m128i*)((int8_t*)out + 64), _mm512_cvtsepi32_epi8(in0_4_32i));
  _mm_storeu_si128(
      (__m128i*)((int8_t*)out + 80), _mm512_cvtsepi32_epi8(in0_5_32i));
  _mm_storeu_si128(
      (__m128i*)((int8_t*)out + 96), _mm512_cvtsepi32_epi8(in0_6_32i));
  _mm_storeu_si128(
      (__m128i*)((int8_t*)out + 112), _mm512_cvtsepi32_epi8(in0_7_32i));
}
