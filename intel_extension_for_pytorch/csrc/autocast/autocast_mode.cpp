...
MAKE_REGISTER_FUNC(
    ...
    Tensor(const Tensor&, const Tensor&, const c10::optional<Tensor>&, int64_t),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(polar),
    "polar",
...
MAKE_REGISTER_FUNC(
    ADD_NS(prod),
    "prod",
    Tensor(const Tensor&, c10::optional<at::ScalarType>),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(prod),
    "prod.dim_int",
    Tensor(const Tensor&, int64_t, bool, c10::optional<at::ScalarType>),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(prod),
    "prod.dim_Dimname",
    Tensor(const Tensor&, at::Dimname, bool, c10::optional<at::ScalarType>),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(quantile),
    "quantile",
    Tensor(const Tensor&, const Tensor&, c10::optional<int64_t>, bool),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(quantile),
    "quantile.scalar",
...
MAKE_REGISTER_FUNC(
    ADD_NS(cumprod),
    "cumprod",
    Tensor(const Tensor&, int64_t, c10::optional<at::ScalarType>),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(cumprod),
    "cumprod.dimname",
    Tensor(const Tensor&, at::Dimname, c10::optional<at::ScalarType>),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(cumsum),
    "cumsum",
...
MAKE_REGISTER_FUNC(
    ADD_NS(histc),
    "histc",
    Tensor(const Tensor&, int64_t, const at::Scalar&, const at::Scalar&),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(logcumsumexp),
    "logcumsumexp",
...
MAKE_REGISTER_FUNC(
    ADD_NS(vander),
    "vander",
    Tensor(const Tensor&, c10::optional<int64_t>, bool),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(view_as_complex),
    "view_as_complex",
    Tensor(const Tensor&),
    fp32)
MAKE_REGISTER_FUNC(
    ...
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(cholesky_inverse),
    "cholesky_inverse",
    Tensor(const Tensor&, bool),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(cholesky_solve),
    "cholesky_solve",
...
MAKE_REGISTER_FUNC(
    ADD_NS(ormqr),
    "ormqr",
    Tensor(const Tensor&, const Tensor&, const Tensor&, bool, bool),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(pinverse),
    "pinverse",
...
MAKE_REGISTER_FUNC(
    ADD_NS(max_unpool3d),
    "max_unpool3d",
    Tensor(const Tensor&, const Tensor&, IntArrayRef, IntArrayRef, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(adaptive_avg_pool3d),
    "adaptive_avg_pool3d",
    Tensor(const Tensor&, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(reflection_pad1d),
    "reflection_pad1d",
    Tensor(const Tensor&, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(reflection_pad2d),
    "reflection_pad2d",
    Tensor(const Tensor&, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(replication_pad1d),
    "replication_pad1d",
    Tensor(const Tensor&, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(replication_pad2d),
    "replication_pad2d",
    Tensor(const Tensor&, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(replication_pad3d),
    "replication_pad3d",
    Tensor(const Tensor&, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
...
MAKE_REGISTER_FUNC(
    ...
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_svdvals),
    "linalg_svdvals",
    Tensor(const Tensor&),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_eigvals),
    "linalg_eigvals",
    Tensor(const Tensor&),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_eigvalsh),
    "linalg_eigvalsh",
    Tensor(const Tensor&, c10::string_view),
    fp32)
MAKE_REGISTER_FUNC(
    ...
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_householder_product),
    "linalg_householder_product",
    Tensor(const Tensor&, const Tensor&),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_tensorinv),
    "linalg_tensorinv",
    Tensor(const Tensor&, int64_t),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_tensorsolve),
    "linalg_tensorsolve",
    Tensor(const Tensor&, const Tensor&, c10::optional<at::IntArrayRef>),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(fake_quantize_per_tensor_affine),
...
MAKE_REGISTER_FUNC(
    ADD_NS(eig),
    "eig",
    TUPLE_TWO_TENSORS(const Tensor&, bool),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(geqrf),
    "geqrf",
...
MAKE_REGISTER_FUNC(
    ADD_NS(lstsq),
    "lstsq",
    TUPLE_TWO_TENSORS(const Tensor&, const Tensor&),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(_lu_with_info),
    "_lu_with_info",
...
MAKE_REGISTER_FUNC(
    ...
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(triangular_solve),
    "triangular_solve",
    TUPLE_TWO_TENSORS(const Tensor&, const Tensor&, bool, bool, bool),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(fractional_max_pool2d),
    "fractional_max_pool2d",
    TUPLE_TWO_TENSORS(const Tensor&, IntArrayRef, IntArrayRef, const Tensor&),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(fractional_max_pool3d),
    "fractional_max_pool3d",
    TUPLE_TWO_TENSORS(const Tensor&, IntArrayRef, IntArrayRef, const Tensor&),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(adaptive_max_pool3d),
    "adaptive_max_pool3d",
    TUPLE_TWO_TENSORS(const Tensor&, IntArrayRef),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(multilabel_margin_loss_forward),
...
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_qr),
    "linalg_qr",
    TUPLE_TWO_TENSORS(const Tensor&, c10::string_view),
    fp32)
MAKE_REGISTER_FUNC(
...
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_svd),
    "linalg_svd",
    TUPLE_THREE_TENSORS(const Tensor&, bool),
    fp32)
MAKE_REGISTER_FUNC(
    ADD_NS(linalg_eig),
    "linalg_eig",
