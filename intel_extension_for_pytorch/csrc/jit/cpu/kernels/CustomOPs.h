...
class AtenIpexJITDev {
 public:
  // for JIT ops
  static at::Tensor dil_convolution_base(
  ...
  static at::Tensor dil_convolution_relu(
      const at::Tensor& input,
      const at::Tensor& weight,
      const at::Tensor& bias,
      at::IntArrayRef stride,
  ...
  static at::Tensor& dil_convolution_sum(
      const at::Tensor& input,
      const at::Tensor& weight,
      const at::Tensor& bias,
      at::IntArrayRef stride,
  ...
  static at::Tensor& dil_convolution_sum_relu(
      const at::Tensor& input,
      const at::Tensor& weight,
      const at::Tensor& bias,
      at::IntArrayRef stride,
  ...
  static at::Tensor dil_max_pool2d(
      const at::Tensor& input,
  ...
  static at::Tensor dil_qinteraction(
