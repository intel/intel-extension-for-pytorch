...
#include "csrc/aten/cpu/LayerNorm.h"
...
at::Tensor AtenIpexJITDev::dil_convolution_base(
  ...
  RECORD_FUNCTION(
      "AtenIpexJITDev::dil_convolution_base", std::vector<c10::IValue>({}));
#endif
...
#if defined(IPEX_PROFILE_OP)
  RECORD_FUNCTION(
      "AtenIpexJITDev::dil_matmul_div_fallback", std::vector<c10::IValue>({}));
#endif
  if (out.defined()) {
...
at::Tensor AtenIpexJITDev::dil_matmul_div(
...
#if defined(IPEX_PROFILE_OP)
  RECORD_FUNCTION(
      "AtenIpexJITDev::dil_matmul_div_scalar", std::vector<c10::IValue>({}));
#endif
  ...
  if (dim_tensor1 == dim_tensor2 && dim_tensor1 >= 3) {
    ...
    return AtenIpexJITDev::dil_matmul_div(
...
#if defined(IPEX_PROFILE_OP)
  RECORD_FUNCTION(
      "AtenIpexJITDev::dil_convolution_relu", std::vector<c10::IValue>({}));
#endif
  return convolution_impl(
      input,
      weight,
...
#if defined(IPEX_PROFILE_OP)
  RECORD_FUNCTION(
      "AtenIpexJITDev::dil_convolution_sum", std::vector<c10::IValue>({}));
#endif
...
#if defined(IPEX_PROFILE_OP)
  RECORD_FUNCTION(
      "AtenIpexJITDev::dil_convolution_sum_relu", std::vector<c10::IValue>({}));
#endif
  auto scale = alpha.to<float>();
  convolution_inplace_impl(
      input,
...
#if defined(IPEX_PROFILE_OP)
  RECORD_FUNCTION(
      "AtenIpexJITDev::dil_max_pool2d", std::vector<c10::IValue>({}));
#endif
  TORCH_CHECK(
      std::all_of(
