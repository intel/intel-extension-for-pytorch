...
"""
    if args.convert_fp64_to_fp32:
        monkey_patch += \
"""ipex.xpu.overrides.convert_default_dtype(torch.float64, torch.float32, True)
"""
...
def init_parser(parser):
    ...
    # positional
    parser.add_argument("--convert-fp64-to-fp32", action="store_true", dest='convert_fp64_to_fp32',
...
def main():
    parser = ArgumentParser(description="This is a script for launching PyTorch training and inference on Intel GPU Series"
