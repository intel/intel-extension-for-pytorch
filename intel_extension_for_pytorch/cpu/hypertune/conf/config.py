...
launcher_hyperparam_default_search_space = {'hp': ['ncore_per_instance', 'ninstances', 'use_all_nodes', 'use_logical_core', 'disable_numactl', 'disable_iomp', 'malloc'],
...
launcher_schema = Schema({
                          ...
                          Optional('use_all_nodes', default=[True, False] if cpuinfo.node_nums() > 1 else [True]):And(list, lambda s: all(isinstance(i, bool) for i in s)),
