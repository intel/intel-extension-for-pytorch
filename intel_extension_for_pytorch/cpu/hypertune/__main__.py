...
def parse_args():
    ...
    action.add_argument('--conf-file', '--conf_file', help='Configuration file for hypertuning')
    parser.add_argument('program', type=str, help='The full path to the proram/script to be launched. followed by all the arguments for the script')
