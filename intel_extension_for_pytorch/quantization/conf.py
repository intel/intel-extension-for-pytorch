...
class QuantConf(object):
    ...
    Args:
        ...
        id: The number of quantized ops in the model running flow. Note: only limited ops are reordered, such as convolution, linear or other ops.
        ...
        weight_granularity: Qscheme for weight quantizer for convolution and linear, can be per_channel or per_tesor, user can manually set it before load existed configure file. The default value is uint8.
