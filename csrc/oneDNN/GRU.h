...
static inline void gru_forward(
  ...
  rnn_direction dir = reverse? rnn_direction::unidirectional_right2left : rnn_direction::unidirectional_left2right;

  memory::dims src_layer_dims = {seq_length, mini_batch, input_size}; // src_layer, tnc
  memory::dims src_iter_dims = {1, 1, mini_batch, hidden_size}; // ldnc src_iter, src_layer hidden state
  memory::dims weights_layer_dims = {1, 1, input_size, num_gate, hidden_size}; // weight for src_layer, ldigo
  memory::dims weights_iter_dims = {1, 1, hidden_size, num_gate, hidden_size}; // weight for hidden, ldigo
  memory::dims bias_dims = {1, 1, num_bias_gate, hidden_size}; // ldgo
  memory::dims dst_layer_dims = {seq_length, mini_batch, hidden_size}; // tnc
  memory::dims dst_iter_dims = {1, 1, mini_batch, hidden_size}; // ldnc   dst_iter, dst_layer hidden state

  dst_layer = at::empty(dst_layer_dims, src_layer.options());
  dst_iter = at::empty(dst_iter_dims, src_iter.options());

  auto src_layer_md
        = memory::desc({src_layer_dims}, data_t, format_any);
  auto weights_layer_md = memory::desc(
          {weights_layer_dims}, data_t, format_any);
  ...
  auto dst_layer_md
          = memory::desc({dst_layer_dims}, data_t, format_any);
  auto dst_iter_md
          = memory::desc({dst_iter_dims}, data_t, format_any);

  auto gru_forward_desc = lbr_gru_forward::desc(
    train ? prop_kind::forward_training : prop_kind::forward_inference,
    dir, src_layer_md, src_iter_md,
    weights_layer_md, weights_iter_md, bias_md,
    dst_layer_md, dst_iter_md);

  auto gru_forward_pd = lbr_gru_forward::primitive_desc(gru_forward_desc, engine);


  auto weights_layer_usr_memory = dpcpp_onednn_memory({{weights_layer_dims}, data_t, format_ldigo}, engine, weight_layer.data_ptr());

  auto weights_iter_usr_memory = dpcpp_onednn_memory({{weights_iter_dims}, data_t, format_ldigo}, engine, weight_iter.data_ptr());

  auto bias_usr_memory = dpcpp_onednn_memory({{bias_dims}, data_t, format_ldgo}, engine, bias.data_ptr());

  auto src_layer_usr_memory = dpcpp_onednn_memory({{src_layer_dims}, data_t, format_tnc}, engine, src_layer.data_ptr());

  auto src_iter_usr_memory = dpcpp_onednn_memory({{src_iter_dims}, data_t, format_ldnc}, engine, src_iter.data_ptr());

  auto dst_layer_usr_memory = dpcpp_onednn_memory({{dst_layer_dims}, data_t, format_tnc}, engine, dst_layer.data_ptr());

  auto dst_iter_usr_memory = dpcpp_onednn_memory({{dst_iter_dims}, data_t, format_ldnc}, engine, dst_iter.data_ptr());
  ...
  if (weights_layer_usr_memory.get_desc() != expected_weights_layer_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(weights_layer_usr_memory, weights_layer_memory),
  ...
  if (weights_iter_usr_memory.get_desc() != expected_weights_iter_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(weights_iter_usr_memory, weights_iter_memory),
  ...
  if (bias_usr_memory.get_desc() != expected_bias_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(bias_usr_memory, bias_memory),
  ...
  if (src_layer_usr_memory.get_desc() != expected_src_layer_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(src_layer_usr_memory, src_layer_memory),
  ...
  if (src_iter_usr_memory.get_desc() != expected_src_iter_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(src_iter_usr_memory, src_iter_memory),
  ...
  if (dst_layer_usr_memory.get_desc() != expected_dst_layer_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(dst_layer_usr_memory, dst_layer_memory),
  ...
  if (dst_iter_usr_memory.get_desc() != expected_dst_iter_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(dst_iter_usr_memory, dst_iter_memory),
  ...
  if(train){
    ...
    auto workspace_memory = dpcpp_onednn_memory(workspace_md, engine, workspace.data_ptr());

    DPCPP_ONEDNN_EXEC(gru_forward_p, strm, {{DNNL_ARG_SRC_LAYER, src_layer_memory},
  ...
  if (dst_layer_memory != dst_layer_usr_memory) {
    DPCPP_ONEDNN_EXEC(dnnl::reorder(dst_layer_memory, dst_layer_usr_memory),
        strm, {{DNNL_ARG_FROM, dst_layer_memory}, {DNNL_ARG_TO, dst_layer_usr_memory}});
  }

  if (dst_iter_memory != dst_iter_usr_memory) {
    DPCPP_ONEDNN_EXEC(dnnl::reorder(dst_iter_memory, dst_iter_usr_memory),
...
static inline void gru_backward(
  ...
  auto gru_forward_desc = lbr_gru_forward::desc(prop_kind::forward_training,
      dir, src_layer_md, src_iter_md,
    weights_layer_md, weights_iter_md, bias_md,
    dst_layer_md, dst_iter_md);
  ...
  auto gru_backward_desc = lbr_gru_backward::desc(prop_kind::backward,
    dir, src_layer_md, src_iter_md,
    weights_layer_md, weights_iter_md, bias_md,
    dst_layer_md, dst_iter_md, diff_src_layer_md,
    diff_src_iter_md, diff_weights_layer_md,
    diff_weights_iter_md, diff_bias_md, diff_dst_layer_md,
    diff_dst_iter_md);
  ...
  auto diff_src_layer_usr_memory = dpcpp_onednn_memory({{src_layer_dims}, data_t, format_tnc}, engine, diff_src_layer.data_ptr());

  auto diff_src_iter_usr_memory = dpcpp_onednn_memory({{src_iter_dims}, data_t, format_ldnc}, engine, diff_src_iter.data_ptr());

  auto diff_dst_layer_usr_memory = dpcpp_onednn_memory({{dst_layer_dims}, data_t, format_tnc}, engine, diff_dst_layer.data_ptr());

  auto diff_dst_iter_usr_memory = dpcpp_onednn_memory({{dst_iter_dims}, data_t, format_ldnc}, engine, diff_dst_iter.data_ptr());

  auto diff_weights_layer_usr_memory = dpcpp_onednn_memory({{weights_layer_dims}, data_t, format_ldigo}, engine, diff_weight_layer.data_ptr());

  auto diff_weights_iter_usr_memory = dpcpp_onednn_memory({{weights_iter_dims}, data_t, format_ldigo}, engine, diff_weight_iter.data_ptr());

  auto diff_bias_usr_memory = dpcpp_onednn_memory({{bias_dims}, data_t, format_ldgo}, engine, diff_bias.data_ptr());

  auto gru_backward_pd = lbr_gru_backward::primitive_desc(gru_backward_desc, engine, gru_forward_pd);
  ...
  if (weights_layer_usr_memory.get_desc() != bwd_expected_weights_layer_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(weights_layer_usr_memory, bwd_weights_layer_memory),
        strm, {{DNNL_ARG_FROM, weights_layer_usr_memory}, {DNNL_ARG_TO, bwd_weights_layer_memory}});
  }
  ...
  if (weights_iter_usr_memory.get_desc() != bwd_expected_weights_iter_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(weights_iter_usr_memory, bwd_weights_iter_memory),
        strm, {{DNNL_ARG_FROM, weights_iter_usr_memory}, {DNNL_ARG_TO, bwd_weights_iter_memory}});
  }
  ...
  if (diff_dst_layer_usr_memory.get_desc() != expected_diff_dst_layer_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(diff_dst_layer_usr_memory, diff_dst_layer_memory),
        strm, {{DNNL_ARG_FROM, diff_dst_layer_usr_memory}, {DNNL_ARG_TO, diff_dst_layer_memory}});
  }
  ...
  if (diff_dst_iter_usr_memory.get_desc() != expected_diff_dst_iter_md) {
    ...
    DPCPP_ONEDNN_EXEC(dnnl::reorder(diff_dst_iter_usr_memory, diff_dst_iter_memory),
        strm, {{DNNL_ARG_FROM, diff_dst_iter_usr_memory}, {DNNL_ARG_TO, diff_dst_iter_memory}});
  }

  auto expected_diff_weights_layer_md = gru_backward_pd.diff_weights_layer_desc();
  auto diff_weights_layer_memory = diff_weights_layer_usr_memory;
  if (diff_weights_layer_usr_memory.get_desc() != expected_diff_weights_layer_md) {
  ...
  if (diff_weights_iter_usr_memory.get_desc() != expected_diff_weights_iter_md) {
  ...
  auto workspace_memory = dpcpp_onednn_memory(gru_backward_pd.workspace_desc(), engine, workspace.data_ptr());

  auto gru_backward_p = lbr_gru_backward(gru_backward_pd);

  DPCPP_ONEDNN_EXEC(gru_backward_p, strm,
  ...
  if(diff_src_layer_usr_memory != diff_src_layer_memory){
    DPCPP_ONEDNN_EXEC(dnnl::reorder(diff_src_layer_memory, diff_src_layer_usr_memory),
        strm, {{DNNL_ARG_FROM, diff_src_layer_memory}, {DNNL_ARG_TO, diff_src_layer_usr_memory}});
  }
  if(diff_src_iter_usr_memory != diff_src_iter_memory){
    DPCPP_ONEDNN_EXEC(dnnl::reorder(diff_src_iter_memory, diff_src_iter_usr_memory),
        strm, {{DNNL_ARG_FROM, diff_src_iter_memory}, {DNNL_ARG_TO, diff_src_iter_usr_memory}});
  }
  if(diff_weights_layer_usr_memory != diff_weights_layer_memory){
    DPCPP_ONEDNN_EXEC(dnnl::reorder(diff_weights_layer_memory, diff_weights_layer_usr_memory),
        strm, {{DNNL_ARG_FROM, diff_weights_layer_memory}, {DNNL_ARG_TO, diff_weights_layer_usr_memory}});
  }
  if(diff_weights_iter_usr_memory != diff_weights_iter_memory){
    DPCPP_ONEDNN_EXEC(dnnl::reorder(diff_weights_iter_memory, diff_weights_iter_usr_memory),
        strm, {{DNNL_ARG_FROM, diff_weights_iter_memory}, {DNNL_ARG_TO, diff_weights_iter_usr_memory}});
  }
  if(diff_bias_usr_memory != diff_bias_memory){
    DPCPP_ONEDNN_EXEC(dnnl::reorder(diff_bias_memory, diff_bias_usr_memory),
        strm, {{DNNL_ARG_FROM, diff_bias_memory}, {DNNL_ARG_TO, diff_bias_usr_memory}});
  }
