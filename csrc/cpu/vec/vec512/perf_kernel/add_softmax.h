...
inline __m512h _dil_exp_half_kernel(__m512h vec_src)
{
  ...
  auto vec_fx_i = _mm512_cvt_roundph_epi16(vec_fx, _MM_FROUND_TO_NEG_INF |
                                                       _MM_FROUND_NO_EXC);
...
inline void _dil_exp_reduce_sum_fusion_kernel(
  ...
  if (i < size) {
    __mmask32 mask = (1 << (size - i)) - 1;
    auto vec_a = (__m512h)(_mm512_mask_loadu_epi16((__m512i)(vec_max), mask,
                                                   (__m512i *)(a + i)));
