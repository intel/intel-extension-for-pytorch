...
struct IPEX_API DeviceProp {
  ...
  // dpcpp_info_t<DPCPP::info::device, dpcpp_dev_backend_version> backend_version;
  ...
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_max_compute_units> max_compute_units;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_max_work_item_dims> max_work_item_dims;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_max_work_group_size> max_work_group_size;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_max_num_subgroup> max_num_subgroup;
  ...
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_max_alloc_size> max_mem_alloc_size;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_mem_base_addr_align> base_addr_align;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_half_fp_config> half_fp_config;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_single_fp_config> single_fp_config;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_double_fp_config> double_fp_config;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_global_mem_size> global_mem_size;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_global_mem_cache_type> global_mem_cache_type;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_global_mem_cache_size> global_mem_cache_size;
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_global_mem_cache_line_size> global_mem_cache_line_size;
  ...
  dpcpp_info_t<DPCPP::info::device, dpcpp_dev_profiling_resolution> profiling_resolution;
};
