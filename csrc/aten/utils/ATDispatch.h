...
#define IPEX_QINT_PRIVATE_CASE_TYPE(enum_type, type, underlying_enum, underlying_type, ...) \
  case enum_type: {                                                     \
...
#define IPEX_DISPATCH_FLOATING_TYPES_AND(SCALARTYPE, TYPE, NAME, ...)                     \
  [&] {                                                                                   \
    ...
    switch (_st) {                                                                        \
      IPEX_PRIVATE_CASE_DOUBLE(at::ScalarType::Double, double, __VA_ARGS__)               \
      IPEX_PRIVATE_CASE_TYPE(at::ScalarType::Float, float, __VA_ARGS__)                   \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE,                                                  \
...
#define IPEX_DISPATCH_FLOATING_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...)      \
  [&] {                                                                                   \
    ...
    switch (_st) {                                                                        \
      IPEX_PRIVATE_CASE_DOUBLE(at::ScalarType::Double, double, __VA_ARGS__)               \
      IPEX_PRIVATE_CASE_TYPE(at::ScalarType::Float, float, __VA_ARGS__)                   \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE1,                                                 \
          decltype(c10::impl::ScalarTypeToCPPType<SCALARTYPE1>::t), __VA_ARGS__)          \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE2,                                                 \
...
#define IPEX_DISPATCH_FLOATING_AND_COMPLEX_TYPES(TYPE, NAME, ...)                                                  \
  [&] {                                                                                                            \
    ...
    switch (_st) {                                                                                                 \
      IPEX_PRIVATE_CASE_DOUBLE(at::ScalarType::Double, double, __VA_ARGS__)                                        \
      IPEX_PRIVATE_CASE_TYPE(at::ScalarType::Float, float, __VA_ARGS__)                                            \
      IPEX_PRIVATE_CASE_DOUBLE(at::ScalarType::ComplexDouble, std::complex<double>, __VA_ARGS__)                   \
      IPEX_PRIVATE_CASE_TYPE(at::ScalarType::ComplexFloat, std::complex<float>, __VA_ARGS__)                       \
      default:                                                                                                     \
        AT_ERROR(#NAME, " not implemented for '", toString(_st), "'");                                             \
    }                                                                                                              \
  }()
...
#define IPEX_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND1(SCALARTYPE, TYPE, NAME, ...)                                 \
  [&] {                                                                                                            \
    ...
    switch (_st) {                                                                                                 \
      ...
      IPEX_PRIVATE_CASE_DOUBLE(at::ScalarType::ComplexDouble, std::complex<double>, __VA_ARGS__)                   \
      IPEX_PRIVATE_CASE_TYPE(at::ScalarType::ComplexFloat, std::complex<float>, __VA_ARGS__)                       \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE, decltype(c10::impl::ScalarTypeToCPPType<SCALARTYPE>::t), __VA_ARGS__)     \
      default:                                                                                                     \
        AT_ERROR(#NAME, " not implemented for '", toString(_st), "'");                                             \
    }                                                                                                              \
  }()
...
#define IPEX_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...)                   \
  [&] {                                                                                                            \
    ...
    switch (_st) {                                                                                                 \
      ...
      IPEX_PRIVATE_CASE_DOUBLE(at::ScalarType::ComplexDouble, std::complex<double>, __VA_ARGS__)                   \
      IPEX_PRIVATE_CASE_TYPE(at::ScalarType::ComplexFloat, std::complex<float>, __VA_ARGS__)                       \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE1, decltype(c10::impl::ScalarTypeToCPPType<SCALARTYPE1>::t), __VA_ARGS__)   \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE2, decltype(c10::impl::ScalarTypeToCPPType<SCALARTYPE2>::t), __VA_ARGS__)   \
      default:                                                                                                     \
        AT_ERROR(#NAME, " not implemented for '", toString(_st), "'");                                             \
    }                                                                                                              \
  }()
...
#define IPEX_DISPATCH_ALL_TYPES_AND3(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, TYPE, NAME, ...)                       \
  [&] {                                                                                                            \
    switch (TYPE) {                                                                                                \
      ...
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE1, decltype(c10::impl::ScalarTypeToCPPType<SCALARTYPE1>::t), __VA_ARGS__)   \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE2, decltype(c10::impl::ScalarTypeToCPPType<SCALARTYPE2>::t), __VA_ARGS__)   \
      IPEX_PRIVATE_CASE_TYPE(SCALARTYPE3, decltype(c10::impl::ScalarTypeToCPPType<SCALARTYPE3>::t), __VA_ARGS__)   \
      default:                                                                                                     \
        AT_ERROR(#NAME, " not implemented for '", toString(TYPE), "'");                                            \
    }                                                                                                              \
  }()
