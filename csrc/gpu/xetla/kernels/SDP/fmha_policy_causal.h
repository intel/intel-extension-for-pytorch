...
// inference f==1
// GPTJ Hs=256
struct fmha_policy_f8_t1024_h256 : fmha_policy_base {
  static constexpr uint32_t kBr = 8;
  static constexpr uint32_t kSgBr = 8;
  static constexpr uint32_t kBc = 256;
  static constexpr uint32_t kSgBc = 16;
...
struct fmha_policy_f8_t64_h256 : fmha_policy_base {
  static constexpr uint32_t kBr = 8;
  static constexpr uint32_t kSgBr = 8;
...
// LLAMA/OPT Hs=128
struct fmha_policy_f8_t1024_h128 : fmha_policy_base {
  static constexpr uint32_t kBr = 8;
  static constexpr uint32_t kSgBr = 8;
  static constexpr uint32_t kBc = 256;
  static constexpr uint32_t kSgBc = 32;
...
struct fmha_policy_f8_t64_h128 : fmha_policy_base {
  static constexpr uint32_t kBr = 8;
  static constexpr uint32_t kSgBr = 8;
  static constexpr uint32_t kBc = 64;
  static constexpr uint32_t kSgBc = 16;
