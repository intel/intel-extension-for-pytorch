...
std::enable_if_t<
    !std::is_same<remove_const_t<T0>, remove_const_t<T1>>::value,
    remove_const_t<T0>>
...
template <typename T, int SZ>
__XETLA_API xetla_vector<T, SZ> xetla_add_c(
    xetla_vector<T, SZ> src0,
    xetla_vector<T, SZ> src1,
...
__XETLA_API xetla_vector<T0, SZ> xetla_imul(
    xetla_vector_ref<T0, SZ> __REF__ lo,
