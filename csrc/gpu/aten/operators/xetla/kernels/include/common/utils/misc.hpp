...
__XETLA_API xetla_vector<dtype_acc, N> drop_out(
    xetla_vector<dtype_acc, N> in,
...
__XETLA_API typename std::
    enable_if_t<reduce_kind == reduce_op::sum, xetla_vector<dtype, size>>
...
template <reduce_op reduce_kind, typename dtype, int size>
__XETLA_API typename std::
    enable_if_t<reduce_kind == reduce_op::prod, xetla_vector<dtype, size>>
    reduce_helper(xetla_vector<dtype, size> a, xetla_vector<dtype, size> b) {
  return a * b;
}
...
template <reduce_op reduce_kind, typename dtype, int size>
__XETLA_API typename std::
    enable_if_t<reduce_kind == reduce_op::max, xetla_vector<dtype, size>>
    reduce_helper(xetla_vector<dtype, size> a, xetla_vector<dtype, size> b) {
...
template <reduce_op reduce_kind, typename dtype, int size>
__XETLA_API typename std::
    enable_if_t<reduce_kind == reduce_op::min, xetla_vector<dtype, size>>
    reduce_helper(xetla_vector<dtype, size> a, xetla_vector<dtype, size> b) {
  xetla_vector<dtype, size> out;
  xetla_mask<size> mask = a < b;
  out.xetla_merge(a, b, mask);
