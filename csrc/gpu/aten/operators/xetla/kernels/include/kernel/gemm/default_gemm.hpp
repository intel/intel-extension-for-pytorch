...
template <
    ...
    typename dtype_acc,
    gpu_arch gpu_arch_tag = gpu_arch::Xe,
          ...
          typename param_optimizer<
              ...
              typename default_param_t::template update_dict_t<
                  typename tune_option::template update_t<
                      ...
                      elem_v_t<tune_key::GPU_ARCH, gpu_arch_tag>>>>::type> {};
...
template <
    ...
    gpu_arch gpu_arch_tag = gpu_arch::Xe,
    typename tune_option = dict_t<>>
struct default_gemm_t : default_gemm_config_t<
                            dtype_a,
                            mem_layout_a,
                            alignment_a,
                            dtype_b,
...
struct param_optimizer<param_optimizer_tag::KERNEL, dict_t_> {
  static constexpr bool use_rule =
      (dict_t_::impl::template find_elem_index<tune_key::PARAM_OPTIMZER_TYPE> !=
...
struct param_adaptor<param_adaptor_tag::KERNEL, dict_t_>
  ...
  using gemm_t =
      typename param_adaptor<param_adaptor_tag::WORKGROUP_GEMM, param>::type;
  using epilogue_t =
      typename param_adaptor<param_adaptor_tag::WORKGROUP_EPILOGUE, param>::
          type;
...
struct default_gemm_selector_config_t
    : param_adaptor<
          param_adaptor_tag::WORKGROUP_GEMM,
          typename param_optimizer<
              param_optimizer_tag::WORKGROUP,
              typename default_param_t::template update_dict_t<
                  typename tune_option::template update_t<
                      elem_t_t<tune_key::DATA_TYPE_A, dtype_a>,
                      elem_v_t<tune_key::MEMORY_LAYOUT_A, mem_layout_a>,
...
template <
    ...
    gpu_arch gpu_arch_tag = gpu_arch::Xe,
    typename tune_option = dict_t<>>
struct default_gemm_selector_t : default_gemm_selector_config_t<
                                     dtype_a,
                                     mem_layout_a,
                                     alignment_a,
                                     mem_space_a,
...
struct default_epilogue_selector_config_t
    : param_adaptor<
          param_adaptor_tag::WORKGROUP_EPILOGUE,
          typename param_optimizer<
              param_optimizer_tag::WORKGROUP,
              typename default_param_t::template update_dict_t<
                  typename tune_option::template update_t<
...
template <
    ...
    gpu_arch gpu_arch_tag = gpu_arch::Xe,
    typename tune_option = dict_t<>>
struct default_epilogue_selector_t : default_epilogue_selector_config_t<
                                         dtype_c,
                                         mem_layout_c,
                                         alignment_c,
                                         mem_space_c,
