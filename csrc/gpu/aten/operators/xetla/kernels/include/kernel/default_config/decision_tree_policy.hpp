...
struct fallback_optimizer {
  using type = typename opt_dict_t_::template update_t<
      elem_t_t<
          tune_key::DATA_TYPE_A,
          typename dict_t_::template find_elem_t<tune_key::DATA_TYPE_A>::type>,
      elem_t_t<
          tune_key::DATA_TYPE_B,
          typename dict_t_::template find_elem_t<tune_key::DATA_TYPE_B>::type>,
      elem_t_t<
          tune_key::DATA_TYPE_C,
          typename dict_t_::template find_elem_t<tune_key::DATA_TYPE_C>::type>,
      elem_v_t<
          tune_key::MEMORY_LAYOUT_A,
          dict_t_::template find_elem_v<tune_key::MEMORY_LAYOUT_A>>,
      elem_v_t<
          tune_key::MEMORY_LAYOUT_B,
          dict_t_::template find_elem_v<tune_key::MEMORY_LAYOUT_B>>,
      elem_v_t<
          tune_key::MEMORY_LAYOUT_C,
          dict_t_::template find_elem_v<tune_key::MEMORY_LAYOUT_C>>,
      elem_v_t<
          tune_key::MEMORY_ALIGNMENT_A,
          dict_t_::template find_elem_v<tune_key::MEMORY_ALIGNMENT_A>>,
      elem_v_t<
          tune_key::MEMORY_ALIGNMENT_B,
          dict_t_::template find_elem_v<tune_key::MEMORY_ALIGNMENT_B>>,
      elem_v_t<
          tune_key::MEMORY_ALIGNMENT_C,
          dict_t_::template find_elem_v<tune_key::MEMORY_ALIGNMENT_C>>,
      elem_v_t<
          tune_key::GPU_ARCH,
...
struct decision_tree_optimizer : param_optimizer_base {
  struct impl {
    using type = typename dict_t_ ::template update_generator_t<
        ...
        template update_generator_t<decision_tree_rule::tile_shape_handler>::
            template update_generator_t<decision_tree_rule::kslicing_handler>;
    using fallback_type = fallback_optimizer<dict_t_, type>;
  };
  static constexpr bool use_fallback =
      !(param_optimizer_base::
            template validate_attribute<dict_t_, typename impl::type>::value);
  using type = typename std::
