...
tile_store(tile_t& tile, payload_t& payload) {
  ...
  using check_store =
      typename subgroup::check_store<payload_t::arch_tag, dtype, store_dtype>::
...
#pragma unroll
      for (int ii = 0; ii < remained_size_y / remained_st_blk_size_y; ++ii) {
...
tile_store(tile_t& tile, payload_t& payload) {
  using dtype = typename tile_t::dtype;
  using store_dtype = typename payload_t::mem_dtype;
  using check_store = typename subgroup::
      check_store<gpu_arch::Xe, dtype, store_dtype>::global_1d;
...
tile_store(tile_t& tile, payload_t& payload, oob_check_tag tag = {}) {
  ...
  using tile_desc = typename tile_t::tile_desc;
  using check_store = typename subgroup::
      check_store<payload_t::arch_tag, dtype>::template global_atomic<
          payload_t::tile_bytes,
          payload_t::min_store_bytes,
...
tile_store(tile_t& tile, payload_t& payload) {
  ...
  using store_dtype = typename payload_t::mem_dtype;
  using check_store = typename subgroup::
      check_store<gpu_arch::Xe, dtype, store_dtype>::template local_scatter<
          payload_t::tile_bytes,
          payload_t::min_bytes,
          payload_t::block_bytes,
          payload_t::num_channel_x,
...
tile_store(tile_t& tile, payload_t& payload) {
  ...
  using check_store =
      typename subgroup::check_store<gpu_arch::Xe, dtype, store_dtype>::
          template local_scatter_vnni_col<
              payload_t::tile_bytes,
              payload_t::min_store_bytes,
              payload_t::block_bytes,
              payload_t::num_channel_x,
...
tile_store(tile_t& tile, payload_t& payload) {
  ...
  using store_dtype = typename payload_t::mem_dtype;
  using check_store = typename subgroup::
      check_store<gpu_arch::Xe, dtype, store_dtype>::local_1d;
