...
foreach(IMPL_KISDROPOUT ${L_BOOLS})
    ...
    set(fmha_policies)
    # kIsTraining && kIsDropout && arch_tag == gpu_arch::XeHpc
    if((IMPL_KISTRAINING STREQUAL "true") AND (IMPL_KISDROPOUT STREQUAL "true") AND (arch STREQUAL "xe_hpc"))
        list(APPEND fmha_policies "fmha_policy_64x64x64")
        list(APPEND fmha_policies "fmha_policy_128x128x128")
        list(APPEND fmha_policies "fmha_policy_128x128x256")
        list(APPEND fmha_policies "fmha_policy_64x128x512")
    endif()
    list(APPEND fmha_policies "fmha_policy_8x128x64")
    list(APPEND fmha_policies "fmha_policy_64x128x64")
    # arch_tag == gpu_arch::XeLpg && !kIsDropout
    if((IMPL_KISDROPOUT STREQUAL "false") AND (arch STREQUAL "xe_lpg"))
        list(APPEND fmha_policies "stage0<fmha_policy_1x256x128>")
        list(APPEND fmha_policies "stage0<fmha_policy_1x512x128>")
    endif()
    list(APPEND fmha_policies "fmha_policy_8x256x128")
    list(APPEND fmha_policies "fmha_policy_8x512x128")
    if(arch STREQUAL "xe_lpg")
        list(APPEND fmha_policies "stage0<fmha_policy_32x128x128>")
    else()
        list(APPEND fmha_policies "fmha_policy_64x128x128")
    endif()
    if(arch STREQUAL "xe_lpg")
    else()
        list(APPEND fmha_policies "fmha_policy_8x256x256")
        list(APPEND fmha_policies "fmha_policy_64x128x256")
        if(arch STREQUAL "xe_hpc")
            list(APPEND fmha_policies "fmha_policy_64x256x256")
            list(APPEND fmha_policies "fmha_policy_64x128x512")
        endif()
    endif()
    
    foreach(IMPL_FMHA_POLICY ${fmha_policies})
        set(IMPL_ARCH_TAG "${gpu_arch_${arch}}")

        string(REGEX REPLACE "<|>" "" FMHA_POLICY_PREFIX ${IMPL_FMHA_POLICY})
        ...
        set(FILE_SUFFIX "${FILE_SUFFIX}_${FMHA_POLICY_PREFIX}")
