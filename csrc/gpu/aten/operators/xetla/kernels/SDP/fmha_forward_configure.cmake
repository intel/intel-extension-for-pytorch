...
foreach(IMPL_KISFP8KV ${L_BOOLS})
    if((arch STREQUAL "xe_lpg") AND (IMPL_T STREQUAL "bf16"))
        continue()
    endif()
    
    set(IMPL_KV_T "${IMPL_T}")
    if(IMPL_KISFP8KV STREQUAL "true")
        set(IMPL_KV_T "uint8_t")
    endif()
    ...
    set(FILE_SUFFIX "${arch}_${IMPL_T}_${IMPL_KV_T}_")
    ...
    set(FILE_SUFFIX "${FILE_SUFFIX}${BOOL_FLAG_${IMPL_KISVARLEN}}")
