...
template <
    ...
    int SYNC_FREQ,
    int STAGES>
inline void hgemm_qkv_wint4_arc(
    sycl::queue& queue,
    scalar_t* out0,
    scalar_t* out1,
    scalar_t* out2,
...
template <
    ...
    int SYNC_FREQ,
    int STAGES>
inline void hgemm_qkv_bias_wint4_arc(
    sycl::queue& queue,
    scalar_t* out0,
    scalar_t* out1,
    scalar_t* out2,
...
template <
    ...
    int SYNC_FREQ,
    int STAGES>
inline void hgemm_silu_wint4_arc(
    sycl::queue& queue,
    scalar_t* out,
    const scalar_t* a,
    const uint8_t* b,
...
template <
    ...
    int SYNC_FREQ,
    int STAGES>
inline void hgemm_silu_mul_wint4_arc(
    sycl::queue& queue,
    scalar_t* out,
    const scalar_t* a,
    const uint8_t* b,
...
template <
    ...
    int SYNC_FREQ,
    int STAGES>
inline void hgemm_bias_silu_mul_wint4_arc(
    sycl::queue& queue,
    scalar_t* out,
    const scalar_t* a,
    const uint8_t* b,
...
template <
    ...
    int SYNC_FREQ,
    int STAGES>
inline void hgemm_bias_add_wint4_arc(
    sycl::queue& queue,
    scalar_t* out,
    const scalar_t* a,
    const uint8_t* b,
...
template <
    ...
    int SYNC_FREQ,
    int STAGES>
inline void hgemm_res_wint4_arc(
    sycl::queue& queue,
    scalar_t* out,
    const scalar_t* a,
    const uint8_t* b,
