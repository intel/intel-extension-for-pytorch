...
foreach(QUANT_MODE ${L_QUANT_MODE})
    ...
    if(ARCH STREQUAL "xe_lpg")
        ...
        configure_("fp16"      ${arch_tag} ${QUANT_MODE} 1   1   1  1  1024 1 1 0 0)
        configure_("fp16"      ${arch_tag} ${QUANT_MODE} 4   1   4  1  256  1 1 0 0)
    ...
    elseif(ARCH STREQUAL "xe_hpc")
        ...
        configure_("fp16"      ${arch_tag} ${QUANT_MODE} 1   1   1  1  1024 1 1 1 3)
