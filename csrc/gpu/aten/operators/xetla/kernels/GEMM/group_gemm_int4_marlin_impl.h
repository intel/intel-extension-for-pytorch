...
struct group_hgemm_wint4_marlin_func {
  ...
  using compute_policy = gpu::xetla::group::compute_policy_int4_dequantize_v2<
      compute_attr,
      perf_tuning_knob,
      data_type_scale,
      dequant_s,
  ...
  using gemm_op_t =
      gpu::xetla::kernel::int4_group_gemm_universal_t<gemm_t, epilogue_t>;

  static const char* func_name() {
    return "group_hgemm_wint4_marlin_func";
  }
