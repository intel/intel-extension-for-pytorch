...
static inline DPCPP_BOTH scalar_t modified_bessel_i0_forward(scalar_t x) {
  ...
  if (Numerics<scalar_t>::abs(x) <= scalar_t(8.0)) {
      ...
      for (uint8_t index = 1; index < 30; index++) {
          p = q;
          q = a;
          a = ((Numerics<scalar_t>::abs(x) / scalar_t(2.0)) - scalar_t(2.0)) * q - p + A[index];
      }

      return Numerics<scalar_t>::exp(Numerics<scalar_t>::abs(x)) * (scalar_t(0.5) * (a - p));
  }
  ...
  for (uint8_t index = 1; index < 25; index++) {
      p = q;
      q = b;
      b = (scalar_t(32.0) / Numerics<scalar_t>::abs(x) - scalar_t(2.0)) * q - p + B[index];
  }

  return Numerics<scalar_t>::exp(Numerics<scalar_t>::abs(x)) * (scalar_t(0.5) * (b - p)) / Numerics<scalar_t>::sqrt(Numerics<scalar_t>::abs(x));
...
static inline DPCPP_BOTH scalar_t modified_bessel_i1_forward(scalar_t x) {
  ...
  if (Numerics<scalar_t>::abs(x) <= scalar_t(8.0)) {
      ...
      if (x < scalar_t(0.0)) {
          return -(scalar_t(0.5) * (a - p) * Numerics<scalar_t>::abs(x) * Numerics<scalar_t>::exp(Numerics<scalar_t>::abs(x)));
      }
...
static inline DPCPP_BOTH scalar_t modified_bessel_k0_forward(scalar_t x) {
  ...
  if (x == scalar_t(0.0)) {
      return Numerics<scalar_t>::numeric_limits<scalar_t>::infinity();
  }

  if (x < scalar_t(0.0)) {
      return Numerics<scalar_t>::numeric_limits<scalar_t>::quiet_NaN();
  }
  ...
  if (x <= scalar_t(2.0)) {
      ...
      return scalar_t(0.5) * (a - p) - Numerics<scalar_t>::log(0.5 * x) * modified_bessel_i0_forward(x);
  }
  ...
  return Numerics<scalar_t>::exp(-x) * (scalar_t(0.5) * (b - p)) / Numerics<scalar_t>::sqrt(x);
...
static inline DPCPP_BOTH scalar_t modified_bessel_k1_forward(scalar_t x) {
  ...
  if (x <= scalar_t(2.0)) {
      ...
      return Numerics<scalar_t>::log(scalar_t(0.5) * x) * modified_bessel_i1_forward(x) + scalar_t(0.5) * (a - p) / x;
  }
