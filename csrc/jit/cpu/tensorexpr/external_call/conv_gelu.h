...
template <>
struct LoweringFuncTrait<ConvFusedOp::kConvGelu> : public ConvCommonOperations {
  DECLARE_CONV_FUNC_AND_RES(gelu)

  /**
   * @note This operator fuses conv and gelu.
   *
   * Its schema is  "ipex_prepack::convolution_gelu_run(
   *  Tensor input,
   *  *,
   *  str approximate,
