...
class Tester(TestCase):
    ...
    def test_conv_input_dims(self):
        self._test_conv_check(
            ...
            "Expected 4-dimensional input for 4-dimensional weight [33, 16, 3, 3], but got 3-dimensional input of size [20, 16, 50] instead",
        )
    ...
    def test_conv_input_shape(self):
        self._test_conv_check(
            ...
            "Given groups=1, weight of size [33, 16, 3, 3], expected input[20, 30, 50, 100] to have 16 channels, but got 30 channels instead",
        )
    ...
    def test_conv_kernel_size(self):
        self._test_conv_check(
            Conv(16, 33, 60),
            torch.randn(20, 16, 50, 100),
            "Calculated padded input size per channel: (50 x 100). Kernel size: (60 x 60). Kernel size can't be greater than actual input size",
        )
    ...
    def test_conv_transpose_input_dims(self):
        self._test_conv_check(
            ...
            torch.randn(20, 16, 50),
            "Expected 4-dimensional input for 4-dimensional weight [16, 33, 3, 3], but got 3-dimensional input of size [20, 16, 50] instead",
        )
    ...
    def test_conv_transpose_input_shape(self):
        self._test_conv_check(
            ConvTranspose(16, 33, 3),
            torch.randn(20, 30, 50, 100),
            "Given transposed=True, weight of size [16, 33, 3, 3], expected input[20, 30, 50, 100] to have 16 channels, but got 30 channels instead",
        )
