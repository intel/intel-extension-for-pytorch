...
class GLUPointWiseConv(nn.Module):
    ...
    def forward(self, x):
        ...
        # #channel (#dim) in the last dimension of the tensor, so need to switch the dimension first for 1D-Conv case
        x = x.permute([0, 2, 1])
...
class CausalConv1D(nn.Conv1d):
    ...
    If padding is set None, then paddings are set automatically to make it a causal convolution
    where each location would not see any steps on its right.
...
class NemoConvSubsampling(torch.nn.Module):
    ...
    (https://github.com/NVIDIA/NeMo/blob/b367413645d5c72db3c2c96e46e95a34501479cf/
    ...
    def reset_parameters(self):
        ...
        if self._subsampling == "dw_striding":
            with torch.no_grad():
                ...
                # init fc (80 * 64 = 5120 from
                # https://github.com/kssteven418/Squeezeformer/blob/
                # 13c97d6cf92f2844d2cb3142b4c5bfa9ad1a8951/src/models/conformer_encoder.py#L487
...
class MultiHeadedAttention(nn.Module):
    ...
    Args:
        ...
        n_value: int, optional
            if set to values other than -1, use a different dimension for value.
            With the default value (i.e. -1), it is backward compatible.
...
class ConformerEncoder(TransformerEncoderBase):
    ...
    def __init__(  # pylint: disable-all
        ...
        extra_multi_layer_output_idxs=None,
