...
# Thus we need to disable TE here.
                with self._texpr_enable(False):
                    ...
                    # aten::hardsigmoid_ is finally converted into ipex::hardsigmoid because ReplaceHardsigmoidWithIPEX is before ApplyInplaceOptimization
                    if eltwise_fn_name == "hardsigmoid_":
                        self.assertTrue(any(n.kind() == "ipex::hardsigmoid" for n in trace_graph.nodes()))
                    else:
