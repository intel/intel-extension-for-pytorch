...
class AutocastCPUTestLists(object):
    ...
    def __init__(self, dev):
        ...
        self.torch_fp32 = [
            ...
            ("arccosh", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ("asinh", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ("cosh", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ("digamma", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ("exp2", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ...
            ("median", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ("nanmedian", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ("nansum", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
            ...
            ("msort", torch.tensor([[1, 2, 3, 4]], dtype=torch.bfloat16)),
        ...
        self.blacklist_non_float_output_pass_test = [
            ...
            ("argsort", (torch.tensor([0, 10, 3, 0], dtype=torch.bfloat16), 0)),
        ...
        self.torch_fp32_multi_output = [
            ...
            ("mode", (torch.arange(9.).to(torch.bfloat16), -1)),
            ("unique_dim", (torch.arange(9.).to(torch.bfloat16), -1)),
