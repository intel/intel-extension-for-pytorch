...
class TestLauncher(TestCase):
    ...
    def test_iomp_memory_allocator_setup(self):
       ...
       launcher.set_multi_thread_and_allcator(10, disable_iomp=False, enable_tcmalloc=True)
       ...
       launcher.set_multi_thread_and_allcator(10, disable_iomp=False, enable_tcmalloc=False, enable_jemalloc=True) 
