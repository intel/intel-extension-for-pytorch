...
print(x5_out.to("cpu"))
print(x6_out.to("cpu"))
print(y_sycl.lt_(z_sycl).to("cpu"))
print(y_sycl.eq_(z_sycl).to("cpu"))
print(y_sycl.gt_(z_sycl).to("cpu"))
print(y_sycl.le_(z_sycl).to("cpu"))
print(y_sycl.ne_(z_sycl).to("cpu"))
print(y_sycl.ge_(z_sycl).to("cpu"))
