...
from torch.testing._internal.common_utils import (run_tests, load_tests,
                                                  TEST_NUMPY, torch_to_numpy_dtype_dict)
from torch.testing._internal.common_device_type import (instantiate_device_type_tests, 
                                                        dtypes, onlyCPU, expectedFailureMeta)
...
class TestTypePromotion(TestCase):
    ...
    @dtypesIfXPU(*itertools.product(get_all_dtypes(include_bfloat16=False, include_complex=False),
