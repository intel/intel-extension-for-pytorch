...
from torch.testing._internal.common_utils import (
    run_tests, torch_to_numpy_dtype_dict)
from torch.testing._internal.common_device_type import instantiate_device_type_tests, onlyCPU, dtypes, dtypesIfCPU
...
class TestShapeOps(TestCase):
    ...
    @dtypesIfXPU(*get_all_dtypes(include_complex=False, include_bool=False, include_bfloat16=False))
    ...
    @onlyXPU  # CPU is too slow
    @largeTensorTestXPU('17GB')  # 4 tensors of 4GB (in, out) x (torch, numpy) + 1GB
