...
class SerializationMixin(object):
    ...
    def test_serialization_map_location(self):
        ...
        gpu_last_map_locations = [
            'xpu:{}'.format(torch.xpu.device_count() - 1),
        ]
    ...
    @unittest.skipIf(torch.xpu.is_available(), "Testing torch.load on CPU-only machine")
    def test_load_nonexistent_device(self):
        # Setup: create a serialized file object with a 'xpu:0' restore location
        # The following was generated by saving a torch.randn(2, device='xpu') tensor.
        serialized = (b'\x80\x02\x8a\nl\xfc\x9cF\xf9 j\xa8P\x19.\x80\x02M\xe9'
                      ...
                      b'\x00xpu:0q\x04K\x02Ntq\x05QK\x00K\x02\x85q\x06K\x01\x85q'
        ...
        error_msg = r'Attempting to deserialize object on a XPU device'
