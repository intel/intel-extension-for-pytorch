...
class TestFakeProxyTensor(TestCase):
    def test_issue82547(self):
        ...
        self.assertRaisesRegex(
            Exception, "non-Fake Tensor", lambda: make_fx(f, tracing_mode="fake")()
        )
...
def forward(self, a_1):
    ...
    def test_cat(self):
        ...
        self.assertTrue(
            shape_env.evaluate_guards_for_args(torch.randn(1, 10), torch.randn(6, 1))
        )
        self.assertFalse(
            shape_env.evaluate_guards_for_args(torch.randn(1, 2), torch.randn(4, 1))
        )
        assert len(shape_env.guards) == 1
    ...
    def test_symbolic_meta(self):
        ...
        self.assertTrue(
            meta_c.meta["val"].shape[0].get_pyobj() == meta_d.meta["val"].expr
        )
...
symbolic_tensor_failures = {
    ...
    xfail(
        "masked.argmax", ""
    ),  # aten.argmax.default - couldn't find symbolic meta function/decomposition
    xfail(
        "masked.argmin", ""
    ),  # aten.argmin.default - couldn't find symbolic meta function/decomposition
    xfail(
        "masked.cumprod", ""
    ),  # aten._to_copy.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "masked.logaddexp", ""
    ),  # aten.logaddexp.default - couldn't find symbolic meta function/decomposition
    xfail(
        "masked.mean", ""
    ),  # ones() received an invalid combination of arguments - got (torch.Size, device=torch.device, ...
    xfail(
        "masked.median", ""
    ),  # aten.nanmedian.dim - couldn't find symbolic meta function/decomposition
    xfail(
        "masked.norm", ""
    ),  # aten.linalg_vector_norm.default - couldn't find symbolic meta function/decomposition
    xfail(
        "masked.prod", ""
    ),  # aten._to_copy.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "masked.std", ""
    ),  # ones() received an invalid combination of arguments - got (torch.Size, device=torch.device, d...
    xfail(
        "masked.sum", ""
    ),  # aten._to_copy.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "addmv", ""
    ),  # aten.addmv.default - couldn't find symbolic meta function/decomposition
    xfail(
        "addr", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
        "aminmax", ""
    ),  # aten.aminmax.default - couldn't find symbolic meta function/decomposition
    xfail(
        "argmax", ""
    ),  # aten.argmax.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "argsort", ""
    ),  # aten.sort.default - couldn't find symbolic meta function/decomposition
    xfail(
        "argwhere", ""
    ),  # aten.nonzero.default - couldn't find symbolic meta function/decomposition
    xfail(
        "as_strided_scatter", ""
    ),  # aten.as_strided_scatter.default - couldn't find symbolic meta function/decomposition
    xfail(
        "baddbmm", ""
    ),  # aten.baddbmm.default - couldn't find symbolic meta function/decomposition
    xfail(
        "bernoulli", ""
    ),  # aten.bernoulli.default - couldn't find symbolic meta function/decomposition
    xfail(
        "bucketize", ""
    ),  # aten.bucketize.Tensor - couldn't find symbolic meta function/decomposition
    ...
    xfail(
        "constant_pad_nd", ""
    ),  # aten.fill.Scalar - couldn't find symbolic meta function/decomposition
    xfail(
        "count_nonzero", ""
    ...
    xfail(
        "cummax", ""
    ),  # aten.cummax.default - couldn't find symbolic meta function/decomposition
    xfail(
        "cummin", ""
    ),  # aten.cummin.default - couldn't find symbolic meta function/decomposition
    xfail(
        "cumprod", ""
    ...
    xfail(
        "deg2rad", ""
    ),  # aten.deg2rad.default - couldn't find symbolic meta function/decomposition
    xfail(
        "diagonal_scatter", ""
    ),  # aten.diagonal_scatter.default - couldn't find symbolic meta function/decomposition
    xfail(
        "diff", ""
    ),  # aten.empty_like.default - couldn't find symbolic meta function/decomposition
    xfail(
        "dist", ""
    ),  # aten.dist.default - couldn't find symbolic meta function/decomposition
    xfail(
        "dsplit", ""
    ),  # aten.slice.Tensor - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "unflatten", ""
    ),  # RuntimeError: Trying to call aten.size on a tensor with symbolic shapes...
    xfail(
        "frexp", ""
    ),  # aten.frexp.Tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "gather", ""
    ),  # aten.gather.default - couldn't find symbolic meta function/decomposition
    xfail(
        "geqrf", ""
    ...
    xfail(
        "index_fill", ""
    ),  # aten.index_fill.int_Scalar - couldn't find symbolic meta function/decomposition
    ...
    xfail(
        "isclose", ""
    ),  # The underlying op of 'aten.stride' has no overload name '_schema'
    xfail(
        "isin", ""
    ...
    xfail(
        "lerp", ""
    ),  # aten.lerp.Scalar - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.cholesky", ""
    ...
    xfail(
        "linalg.inv", ""
    ),  # aten.linalg_inv_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.inv_ex", ""
    ),  # aten.linalg_inv_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "linalg.svd", ""
    ),  # aten._linalg_svd.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.svdvals", ""
    ),  # aten._linalg_svd.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "logcumsumexp", ""
    ),  # aten.logcumsumexp.default - couldn't find symbolic meta function/decomposition
    xfail(
        "logdet", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    ),  # aten.max.dim - couldn't find symbolic meta function/decomposition
    xfail(
        "median", ""
    ),  # Could not run 'aten::median' with arguments from the 'Meta' backend. This could be becau...
    xfail(
        "meshgrid", "list_of_tensors"
    ),  # Tensors of type TensorImpl do not have numel
    xfail(
    ...
    ),  # aten._adaptive_avg_pool3d.default - couldn't find symbolic meta func...
    xfail(
    ...
    ),  # aten.convolution.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    ),  # argument 'size' must be tuple of ints, but found element of type tor...
    xfail(
    ...
    xfail(
        "nn.functional.glu", ""
    ),  # aten.glu.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    ),  # aten.empty_like.default - couldn't find symbolic meta function/deco...
    xfail(
        "nn.functional.interpolate", "area"
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
        "nn.functional.interpolate", "bicubic"
    ),  # aten.upsample_bicubic2d.vec - couldn't find symbolic meta function/d...
    xfail(
        "nn.functional.interpolate", "bilinear"
    ),  # aten.upsample_bilinear2d.vec - couldn't find symbolic meta function...
    xfail(
    ...
    ),  # aten.upsample_nearest1d.vec - couldn't find symbolic meta function/d...
    xfail(
    ...
    ),  # aten.pixel_shuffle.default - couldn't find symbolic meta function/decompos...
    xfail(
    ...
    ),  # aten.im2col.default - couldn't find symbolic meta function/decomposition
    xfail(
        "nn.functional.upsample_bilinear", ""
    ),  # aten.upsample_bilinear2d.vec - couldn't find symbolic meta function/de...
    xfail(
        "nn.functional.upsample_nearest", ""
    ),  # aten.upsample_nearest1d.vec - couldn't find symbolic meta function/deco...
    xfail(
        "norm", "nuc"
    ),  # aten._linalg_svd.default - couldn't find symbolic meta function/decomposition
    xfail(
        "normal", ""
    ),  # aten.normal.Tensor_Tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "normal", "number_mean"
    ...
    xfail(
        "rad2deg", ""
    ),  # aten.rad2deg.default - couldn't find symbolic meta function/decomposition
    xfail(
        "renorm", ""
    ...
    xfail(
        "round", ""
    ),  # aten.round.default - couldn't find symbolic meta function/decomposition
    xfail(
        "round", "decimals_0"
    ),  # aten.round.decimals - couldn't find symbolic meta function/decomposition
    xfail(
        "round", "decimals_3"
    ),  # aten.round.decimals - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "scatter_add", ""
    ),  # aten.scatter_add.default - couldn't find symbolic meta function/decomposition
    xfail(
        "scatter", ""
    ),  # aten.scatter.src - couldn't find symbolic meta function/decomposition
    xfail(
        "scatter_reduce", "amax"
    ),  # aten.scatter_reduce.two - couldn't find symbolic meta function/decomposition
    xfail(
        "scatter_reduce", "amin"
    ),  # aten.scatter_reduce.two - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "select", ""
    ),  # aten.select.int - couldn't find symbolic meta function/decomposition
    xfail(
        "select_scatter", ""
    ),  # aten.select_scatter.default - couldn't find symbolic meta function/decomposition
    xfail(
        "slice_scatter", ""
    ),  # aten.slice_scatter.default - couldn't find symbolic meta function/decomposition
    xfail(
        "sort", ""
    ),  # aten.sort.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "special.entr", ""
    ),  # aten.special_entr.default - couldn't find symbolic meta function/decomposition
    xfail(
        "special.erfcx", ""
    ),  # aten.special_erfcx.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "special.log_ndtr", ""
    ),  # aten.special_log_ndtr.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "special.ndtri", ""
    ),  # aten.special_ndtri.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "special.xlog1py", ""
    ),  # aten.special_xlog1py.default - couldn't find symbolic meta function/decomposition
    ...
    xfail(
        "symeig", ""
    ),  # aten.symeig.default - couldn't find symbolic meta function/decomposition
    xfail("take_along_dim", ""),  # dtype of indices should be Long but got Float
    xfail(
        "take", ""
    ),  # aten.take.default - couldn't find symbolic meta function/decomposition
    xfail(
        "tensordot", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
        "topk", ""
    ),  # aten.topk.default - couldn't find symbolic meta function/decomposition
    xfail(
        "trapz", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "unfold", ""
    ),  # aten.unfold.default - couldn't find symbolic meta function/decomposition
    xfail(
        "view_as_complex", ""
    ),  # aten.view_as_complex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "view_as", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "unbind", ""
    ),  # aten.unbind.int - couldn't find symbolic meta function/decomposition
}
