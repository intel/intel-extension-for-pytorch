...
def build_constructor_arg_db():
    return {
        ...
        torch.nn.GroupNorm: ((3, 6, 1e-05, True), {}),
        torch.nn.Hardshrink: ((), {}),
        ...
        torch.nn.HuberLoss: ((), {}),
        torch.nn.Identity: ((), {}),
        torch.nn.InstanceNorm1d: ((5, 1e-05, 0.1, True), {}),
        torch.nn.InstanceNorm2d: ((5, 1e-05, 0.1, True), {}),
        torch.nn.InstanceNorm3d: ((5, 1e-05, 0.1, True), {}),
        torch.nn.KLDivLoss: ((), {}),
        torch.nn.L1Loss: ((), {}),
        ...
        torch.ao.nn.quantized.Embedding: ((10, 3), {"factory_kwargs": {}}),
        torch.ao.nn.quantized.EmbeddingBag: ((10, 3), {"factory_kwargs": {}}),
        ...
        torch.ao.nn.quantized.Linear: ((5, 2), {"factory_kwargs": {}}),
        torch.ao.nn.quantized.MaxPool2d: ((3,), {}),
        torch.ao.nn.quantized.Quantize: (
            (0.1, 0),
            {"dtype": torch.int16, "factory_kwargs": {}},
        ),
        ...
        torch.nn.quantized.Embedding: ((10, 3), {"factory_kwargs": {}}),
        torch.nn.quantized.EmbeddingBag: ((10, 3), {"factory_kwargs": {}}),
        ...
        torch.nn.quantized.Linear: ((5, 2), {"factory_kwargs": {}}),
            ...
            if module_is_lazy:
                ...
                for name, param in m.named_parameters():
                    ...
                    if param.dtype.is_floating_point and (
                        not module_needs_factory_kwargs
                    ):
                        test_cls.assertEqual(
                            param.dtype,
                            dtype,
