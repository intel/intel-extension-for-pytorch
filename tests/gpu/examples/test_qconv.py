...
class  TestTorchMethod(TestCase):
    ...
    def test_qconv(self, dtype=torch.float):
        ...
        output_gpu_int8_2 =  torch.ops.quantized.conv2d_relu(q_inputs_gpu, packed_params_gpu, _pair(1),_pair(0),_pair(1),1,scale_out_2,zero_point)
        output_gpu_int8_3 =  torch.ops.quantized.conv2d_relu(q_inputs_gpu, packed_params_gpu, _pair(1),_pair(0),_pair(1),1,scale_out_2,zero_point)
