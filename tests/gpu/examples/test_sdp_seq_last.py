...
res_out = torch.xpu.IpexSDP(query_layer.to('xpu').permute(1, 2, 0, 3), key_layer.to('xpu').permute(1, 2, 0, 3), value_layer.to('xpu').permute(1, 2, 0, 3), None, attention_mask_padded.to('xpu'), None, alpha, beta, 1.0, False, True)
