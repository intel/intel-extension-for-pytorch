...
res_out = torch.xpu.IpexSDP(query_layer.to('xpu').permute(0, 2, 1, 3), key_layer.to('xpu').permute(0, 2, 1, 3), value_layer.to('xpu').permute(0, 2, 1, 3), None, attention_mask_padded.to('xpu'), None, alpha, beta, 1.0, False, False)
# res_out = torch.xpu.IpexSDP(query_layer.to('xpu').permute(0, 2, 1, 3), key_layer.to('xpu').permute(0, 2, 1, 3), value_layer.to('xpu').permute(0, 2, 1, 3), None, None, None, alpha, beta, 1.0, False)
# res_non_pad_out = torch.xpu.IpexSDP(query_layer.to('xpu').permute(0, 2, 1, 3), key_layer.to('xpu').permute(0, 2, 1, 3), value_layer.to('xpu').permute(0, 2, 1, 3), None, attention_mask.to('xpu'), None, alpha, beta, 1.0, False)
