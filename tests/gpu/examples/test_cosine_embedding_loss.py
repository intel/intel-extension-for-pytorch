...
class TestNNMethod(TestCase):
    def test_cosine_embedding_loss(self, dtype=torch.float):
        ...
        print("xpu")
        output_dpcpp_1 = _test_dpcpp(input1_dpcpp, input2_dpcpp, target_dpcpp, "none")

        print("sum")
        print("cpu")
        output_cpu_2 = _test_cpu(input1_cpu, input2_cpu, target_cpu, "sum")
        print("xpu")
        output_dpcpp_2 = _test_dpcpp(input1_dpcpp, input2_dpcpp, target_dpcpp, "sum")

        print("mean")
        print("cpu")
        output_cpu_3 = _test_cpu(input1_cpu, input2_cpu, target_cpu, "mean")
        print("xpu")
        output_dpcpp_3 = _test_dpcpp(input1_dpcpp, input2_dpcpp, target_dpcpp, "mean")
