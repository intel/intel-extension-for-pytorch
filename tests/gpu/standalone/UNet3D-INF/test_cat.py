...
class TestTorchMethod(TestCase):
    def test_cat_array(self, dtype=torch.float):
        user_cpu1 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
        user_cpu2 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
        user_cpu3 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
    ...
    def test_cat_array_bfloat16(self, dtype=torch.bfloat16):
        user_cpu1 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
        user_cpu2 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
        user_cpu3 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
    ...
    def test_cat_array_float16(self, dtype=torch.float16):
        user_cpu1 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
        user_cpu2 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
        user_cpu3 = torch.randn([2, 2, 3], device=cpu_device, dtype=dtype)
