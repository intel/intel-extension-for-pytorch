...
input = torch.tensor([[[1,2]]], dtype=torch.float,  device = cpu_device)#(1,1,2)
input.requires_grad = True
h0 = torch.tensor([[[2,3,2,3]],[[3,4,3,4]],[[4,5,4,5]],[[5,6,5,6]]], dtype=torch.float, device = cpu_device)#(4,1,2)
c0 = torch.tensor([[[6,7,6,7]],[[7,8,7,8]],[[8,9,8,9]],[[9,1,9,1]]], dtype=torch.float, device = cpu_device)#(4,1,2)
...
grad_out = torch.tensor([[[1, 2,3,4,5,6,7,8]]], dtype = torch.float,  device = cpu_device) #(1,1,8)
...
rnn_dpcpp.zero_grad()
h0_dpcpp = torch.tensor([[[2,3,2,3]],[[3,4,3,4]],[[4,5,4,5]],[[5,6,5,6]]], dtype = torch.float,  device = dpcpp_device)
c0_dpcpp = torch.tensor([[[6,7,6,7]],[[7,8,7,8]],[[8,9,8,9]],[[9,1,9,1]]], dtype = torch.float,  device = dpcpp_device)
h0_dpcpp.requires_grad = True
c0_dpcpp.requires_grad = True
output_dpcpp, (hn_dpcpp, cn_dpcpp) = rnn_dpcpp(input_dpcpp, (h0_dpcpp,c0_dpcpp))
