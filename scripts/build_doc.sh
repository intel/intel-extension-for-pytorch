...
if [[ ${DEVICE} == "cpu" ]]; then
    ...
    parse_example "../examples/cpu/inference/python/resnet50_imperative_mode_inference_fp32.py" ${MDEXAMPLE} "(marker_inf_rn50_imp_fp32)" "python"
    parse_example "../examples/cpu/inference/python/bert_imperative_mode_inference_fp32.py" ${MDEXAMPLE} "(marker_inf_bert_imp_fp32)" "python"
    ...
    parse_example "../examples/cpu/inference/python/resnet50_imperative_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_rn50_imp_bf16)" "python"
    parse_example "../examples/cpu/inference/python/bert_imperative_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_bert_imp_bf16)" "python"
