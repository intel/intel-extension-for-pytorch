...
if [[ ${DEVICE} == "cpu" ]]; then
    ...
    parse_example "../examples/cpu/inference/python/python-scripts/bert_torchscript_mode_inference_fp32.py" ${MDEXAMPLE} "(marker_inf_bert_ts_fp32)" "python"
    ...
    parse_example "../examples/cpu/inference/python/python-scripts/resnet50_eager_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_rn50_imp_bf16)" "python"
    parse_example "../examples/cpu/inference/python/python-scripts/bert_eager_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_bert_imp_bf16)" "python"
    parse_example "../examples/cpu/inference/python/python-scripts/resnet50_torchscript_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_rn50_ts_bf16)" "python"
    parse_example "../examples/cpu/inference/python/python-scripts/bert_torchscript_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_bert_ts_bf16)" "python"
    parse_example "../examples/cpu/inference/python/python-scripts/resnet50_torchdynamo_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_rn50_dynamo_bf16)" "python"
    parse_example "../examples/cpu/inference/python/python-scripts/bert_torchdynamo_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_bert_dynamo_bf16)" "python"
    parse_example "../examples/cpu/features/fast_bert/fast_bert_inference_bf16.py" ${MDEXAMPLE} "(marker_feature_fastbert_bf16)" "python"
    parse_example "../examples/cpu/inference/python/python-scripts/int8_quantization_static.py" ${MDEXAMPLE} "(marker_int8_static)" "python"
    ...
    parse_example "../examples/gpu/inference/python/python-scripts/resnet50_torchscript_mode_inference_fp32.py" ${MDEXAMPLE} "(marker_inf_rn50_ts_fp32)" "python"
    parse_example "../examples/gpu/inference/python/python-scripts/bert_torchscript_mode_inference_fp32.py" ${MDEXAMPLE} "(marker_inf_bert_ts_fp32)" "python"
    ...
    parse_example "../examples/gpu/inference/python/python-scripts/resnet50_torchscript_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_rn50_ts_bf16)" "python"
    parse_example "../examples/gpu/inference/python/python-scripts/bert_torchscript_mode_inference_bf16.py" ${MDEXAMPLE} "(marker_inf_bert_ts_bf16)" "python"
    ...
    parse_example "../examples/gpu/inference/python/python-scripts/resnet50_torchscript_mode_inference_fp16.py" ${MDEXAMPLE} "(marker_inf_rn50_ts_fp16)" "python"
    parse_example "../examples/gpu/inference/python/python-scripts/bert_torchscript_mode_inference_fp16.py" ${MDEXAMPLE} "(marker_inf_bert_ts_fp16)" "python"
    ...
    # parse_example "../examples/gpu/inference/python/python-scripts/int8_calibration_static_imperative.py" ${MDEXAMPLE} "(marker_int8_static_imperative)" "python"
    parse_example "../examples/gpu/inference/python/python-scripts/int8_quantization_static.py" ${MDEXAMPLE} "(marker_int8_static)" "python"
    # parse_example "../examples/gpu/inference/python/python-scripts/int8_deployment.py" ${MDEXAMPLE} "(marker_int8_deploy)" "python"
