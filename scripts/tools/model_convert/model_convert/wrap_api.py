...
class WrapAPI:
    ...
    def wrap_api_common(cls, api):
        ...
        def new_api(*args, **kwargs):
            ...
            if pin_memory_device is not None and str(pin_memory_device).find('cuda') != -1:
    ...
    def wrap_api_failure(cls, api):
        @wraps(api)
        def new_api(*args, **kwargs):
            print("Warning: This api is not supported by xpu and will automatically return false in any implementation.")
            return False
        return new_api
