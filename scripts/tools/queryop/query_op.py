...
def main():            
    ...
    native_yaml_path = os.path.join(scripts_root, 'scripts/tools/torchgen/yaml/native_functions.yaml')
    ...
    op_category_df = pd.DataFrame(columns=['structured_delegate', 'register', 'register or not'], data=op_category)
