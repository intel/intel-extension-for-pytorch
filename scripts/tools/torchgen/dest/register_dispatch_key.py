...
"""
    ...
    def get_lazy_reorder(self, schema_name, arg, exprs_symint):
        ...
        if argtype in ['c10::SymIntArrayRef', 'c10::SymInt', 'c10::optional<c10::SymInt>', 'at::OptionalSymIntArrayRef']:
            return '', exprs_symint
...
"""
                ...
                args_exprs_list_symint = [e.expr for e in translate(
                        sig.arguments(), kernel_sig.arguments(), method=False
                    )]
  ...
  const DeviceGuard device_guard(device_or_default(device));"""
                ...
                if self.simple_trace:
                    simple_trace_code = f'torch_ipex::xpu::dpcpp::SimpleTrace trace(\"{name} -> {impl_name}\");'
