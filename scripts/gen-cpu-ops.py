...
def get_dnnl_dispatch_function(ctx, fname, param_vars, dnnl_tensor_param_vars):
    code = ''
...
def generate_aten_to_ipex(ctx, tree, mapsig, rwxtree, fname, sig, rwsig, params, fnopts):
    ...
    code +=  get_dnnl_dispatch_function(ctx, fname, dnnl_op_input_vars, dnnl_op_input_tensor_vars)
