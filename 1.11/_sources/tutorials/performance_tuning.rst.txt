...
Intel® Extension for PyTorch\* should yield a satisfying performance with its default configuration for general usage cases. To squeeze usage of hardware resources further, there are still several configurations that users can tune with. This page shows tutorials for performance tuning guides, as well as introduction of an easy-to-use tool.
