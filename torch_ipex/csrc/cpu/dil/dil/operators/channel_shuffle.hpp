#ifndef DIL_OPERATORS_CHANNEL_SHUFFLE_HPP
#define DIL_OPERATORS_CHANNEL_SHUFFLE_HPP
...
struct channel_shuffle_forward: public dnnl::shuffle_forward {
  ...
  static void compute(const tensor& src,
    ...
    DIL_ENFORCE(src.get_dim(axis) % group == 0, "Invalid channel and group");
    DIL_ENFORCE(src.get_data_type() == data_type::f32, "invalid data type");
