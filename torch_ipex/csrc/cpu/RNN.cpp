...
//
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> mkldnn_rnn(
    const at::Tensor& input_, at::TensorList weight, int64_t weight_stride0,
    const at::Tensor& hx_, const at::Tensor& cx_,
...
std::tuple<at::Tensor, at::Tensor> unpack_hidden(const std::tuple<at::Tensor, at::Tensor>& hidden) {
  return hidden;
}
...
template<>
std::tuple<at::Tensor, at::Tensor> pack_hidden<std::tuple<at::Tensor, at::Tensor>>(const at::Tensor& hx, const at::Tensor& cx) {
...
std::pair<at::Tensor, hidden_type> mkldnn_impl(
    const at::Tensor& input, const hidden_type& hidden,
...
static auto dispatch =
    torch::RegisterOperators()
        .op("torch_ipex::lstm", &torch_ipex::AtenIpexTypeExt::lstm);
}
...
std::tuple<at::Tensor, at::Tensor, at::Tensor> lstm(
    const at::Tensor& input, std::vector<at::Tensor> hx,
