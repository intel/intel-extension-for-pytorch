...
class AtenIpexCPUDev {
 public:
  ...
  static std::tuple<at::Tensor, at::Tensor> dil_matmul_backward(const at::Tensor& grad_output, const at::Tensor& mat1,  const at::Tensor& mat2, at::Scalar alpha);
  static std::tuple<at::Tensor, at::Tensor> dil_mm_backward(const at::Tensor& grad_output, const at::Tensor& self, const at::Tensor& mat2);
  static std::tuple<at::Tensor, at::Tensor, at::Tensor> dil_addmm_backward(const at::Tensor& grad_output, const at::Tensor& mat1, const at::Tensor& mat2, at::Scalar beta, at::Scalar alpha);
  static std::tuple<at::Tensor, at::Tensor, at::Tensor> dil_addbmm_backward(const at::Tensor& grad_output, const at::Tensor& batch1, const at::Tensor& batch2, at::Scalar beta, at::Scalar alpha);
  std::tuple<at::Tensor, at::Tensor, at::Tensor> dil_baddbmm_backward(const at::Tensor& grad_output, const at::Tensor& batch1, const at::Tensor& batch2, at::Scalar beta, at::Scalar alpha);
