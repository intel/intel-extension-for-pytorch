...
TORCH_LIBRARY_FRAGMENT(torch_ipex, m) {
  m.def(
      "sgd_fused_step(Tensor param, Tensor grad, Tensor momentum_buf, Tensor trail, float momentum, float learning_rate, float weight_decay, float dampening, bool nesterov) -> ()",
