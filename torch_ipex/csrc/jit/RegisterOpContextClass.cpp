...
TORCH_LIBRARY(ipex_prepack, m) {
  ...
  m.def(
      ...
      "int[2] padding, int[2] output_padding, int groups, int[2] dilation, int[2] kernel_size,  int output_channel, "
      "bool input_is_channels_last, bool weight_is_prepacked, int[4] input_sizes) "
