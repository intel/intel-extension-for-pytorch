...
void IpexSubgraphRewriter::RegisterDefaultPatterns() {
...
void IpexSubgraphRewriter::RegisterRewritePattern(
...
Module IpexSubgraphRewriter::runOnModule(const Module& module) {
...
void IpexSubgraphRewriter::runOnGraph(
...
void IpexSubgraphRewriter::rewriteSinglePatternOnGraph(
    std::shared_ptr<Graph>& graph,
...
bool IpexSubgraphRewriter::overlapsWithPreviousMatches(const Match* match) {
