...
static struct PyGetSetDef THDPEvent_properties[] = {
  ...
  {"dpcpp_event", (getter)THDPEvent_get_dpcpp_event, nullptr, nullptr, nullptr},
  {nullptr}
};

static PyMethodDef THDPEvent_methods[] = {
  {(char*)"from_ipc_handle", (PyCFunction)(void(*)(void))THDPEvent_from_ipc_handle,
  ...
  {(char*)"elapsed_time", (PyCFunction)THDPEvent_elapsed_time, METH_O, nullptr},
  {(char*)"synchronize", (PyCFunction)THDPEvent_synchronize,
    METH_NOARGS, nullptr},
  {(char*)"ipc_handle", (PyCFunction)THDPEvent_ipc_handle,
    METH_NOARGS, nullptr},
  {nullptr}
};
...
void THDPEvent_init(PyObject *module) {
  ...
  if (PyModule_AddObject(
      module, "_XPUEventBase", (PyObject *)&THDPEventType) < 0) {
    throw python_error();
  }
}
