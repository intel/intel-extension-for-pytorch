...
template <> struct Numerics<int8_t> {
  ...
  static inline int8_t abs(int8_t a) { return DPCPP::abs((int)a); }
...
template <> struct Numerics<at::Half> {
  ...
  static inline at::Half exp(at::Half a) { return DPCPP::exp(float(a)); }
  static inline at::Half exp10(at::Half a) { return DPCPP::exp10(float(a)); }
  static inline at::Half log(at::Half a) { return DPCPP::log(float(a)); }
  static inline at::Half log10(at::Half a) { return DPCPP::log10(float(a)); }
  static inline at::Half log1p(at::Half a) { return DPCPP::log1p(float(a)); }
  static inline at::Half log2(at::Half a) { return DPCPP::log2(float(a)); }
  static inline at::Half expm1(at::Half a) { return DPCPP::expm1(float(a)); }

  static inline at::Half neg(at::Half a) { return -a; }
  static inline at::Half sin(at::Half a) { return DPCPP::sin(float(a)); }
...
template <> struct Numerics<float> {
  ...
  static inline float exp(float a) { return DPCPP::exp(a); }
  static inline float exp10(float a) { return DPCPP::exp10(a); }
  static inline float log(float a) { return DPCPP::log(a); }
  static inline float log10(float a) { return DPCPP::log10(a); }
  static inline float log1p(float a) { return DPCPP::log1p(a); }
  static inline float log2(float a) { return DPCPP::log2(a); }
  static inline float expm1(float a) { return DPCPP::expm1(a); }

  static inline float neg(float a) { return -a; }
  static inline float sin(float a) { return DPCPP::sin(a); }
  static inline float cos(float a) { return DPCPP::cos(a); }
  static inline float sqrt(float a) { return DPCPP::sqrt(a); }
  static inline float rsqrt(float a) { return DPCPP::rsqrt(a); }
  static inline float ceil(float a) { return DPCPP::ceil(a); }
  static inline float floor(float a) { return DPCPP::floor(a); }
  static inline float trunc(float a) { return DPCPP::trunc(a); }

  static inline float acos(float a) { return DPCPP::acos(a); }
  static inline float cosh(float a) { return DPCPP::cosh(a); }
  static inline float asin(float a) { return DPCPP::asin(a); }
  static inline float sinh(float a) { return DPCPP::sinh(a); }
  static inline float tan(float a) { return DPCPP::tan(a); }
  static inline float atan(float a) { return DPCPP::atan(a); }
  static inline float tanh(float a) { return DPCPP::tanh(a); }
  static inline float erf(float a) { return DPCPP::erf(a); }
...
template <> struct Numerics<double> {
  ...
  static inline double exp(double a) { return DPCPP::exp(a); }
  static inline double exp10(double a) { return DPCPP::exp10(a); }
  static inline double log(double a) { return DPCPP::log(a); }
  static inline double log10(double a) { return DPCPP::log10(a); }
  static inline double log1p(double a) { return DPCPP::log1p(a); }
  static inline double log2(double a) { return DPCPP::log2(a); }
  static inline double expm1(double a) { return DPCPP::expm1(a); }

  static inline double neg(double a) { return -a; }
  static inline double sin(double a) { return DPCPP::sin(a); }
  static inline double cos(double a) { return DPCPP::cos(a); }
  static inline double sqrt(double a) { return DPCPP::sqrt(a); }
  static inline double rsqrt(double a) { return DPCPP::rsqrt(a); }
  static inline double ceil(double a) { return DPCPP::ceil(a); }
  static inline double floor(double a) { return DPCPP::floor(a); }
  static inline double trunc(double a) { return DPCPP::trunc(a); }
  static inline double acos(double a) { return DPCPP::acos(a); }
  static inline double cosh(double a) { return DPCPP::cosh(a); }
  static inline double asin(double a) { return DPCPP::asin(a); }
  static inline double sinh(double a) { return DPCPP::sinh(a); }
  static inline double tan(double a) { return DPCPP::tan(a); }
  static inline double atan(double a) { return DPCPP::atan(a); }
  static inline double tanh(double a) { return DPCPP::tanh(a); }
  static inline double erf(double a) { return DPCPP::erf(a); }
