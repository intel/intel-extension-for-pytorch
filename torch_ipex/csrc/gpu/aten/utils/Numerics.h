...
struct Numerics<int8_t> {
  ...
  static inline int8_t abs(int8_t a) { return DP::abs((int)a); }
...
struct Numerics<int16_t> {
  ...
  static inline int16_t abs(int16_t a) { return DP::abs(a); }
...
struct Numerics<int32_t> {
  ...
  static inline int32_t abs(int32_t a) { return DP::abs(a); }
...
struct Numerics<int64_t> {
  ...
  static inline int64_t abs(int64_t a) { return DP::abs(a); }
...
struct Numerics<at::Half> {
  ...
  static inline at::Half exp(at::Half a) { return DP::exp(float(a)); }
  static inline at::Half exp10(at::Half a) { return DP::exp10(float(a)); }
  static inline at::Half log(at::Half a) { return DP::log(float(a)); }
  static inline at::Half log10(at::Half a) { return DP::log10(float(a)); }
  static inline at::Half log1p(at::Half a) { return DP::log1p(float(a)); }
  static inline at::Half log2(at::Half a) { return DP::log2(float(a)); }
  static inline at::Half expm1(at::Half a) { return DP::expm1(float(a)); }

  static inline at::Half neg(at::Half a) { return -a; }
  static inline at::Half sin(at::Half a) { return DP::sin(float(a)); }
  static inline at::Half cos(at::Half a) { return DP::cos(float(a)); }
  static inline at::Half sqrt(at::Half a) { return DP::sqrt(float(a)); }
  static inline at::Half rsqrt(at::Half a) { return DP::rsqrt(float(a)); }
  static inline at::Half ceil(at::Half a) { return DP::ceil(float(a));}
  static inline at::Half floor(at::Half a) { return DP::floor(float(a));}
  static inline at::Half trunc(at::Half a) { return DP::trunc(float(a));}
  static inline at::Half acos(at::Half a) { return DP::acos(float(a));}
  static inline at::Half cosh(at::Half a) { return DP::cosh(float(a));}
  static inline at::Half asin(at::Half a) { return DP::asin(float(a));}
  static inline at::Half sinh(at::Half a) { return DP::sinh(float(a));}
  static inline at::Half tan(at::Half a) { return DP::tan(float(a));}
  static inline at::Half atan(at::Half a) { return DP::atan(float(a));}
  static inline at::Half tanh(float a) { return DP::tanh(float(a)); }
  static inline at::Half erf(float a) { return DP::erf(float(a)); }
  static inline at::Half erfc(float a) { return DP::erfc(float(a)); }
  static inline at::Half round(float a) { return DP::round(float(a)); }
 
  static inline at::Half frac(at::Half a) { return a - DP::trunc(float(a));}
  static inline at::Half atan2(at::Half a, at::Half b) { return DP::atan2(float(a), float(b)); }
  ...
  static inline at::Half pow(at::Half a, at::Half b) { return DP::pow(float(a), float(b)); }
  static inline at::Half abs(at::Half a) { return DP::fabs(float(a)); }
...
struct Numerics<float> {
  ...
  static inline bool lt(float a, float b) { return DP::isless(a, b); }
  static inline bool le(float a, float b) { return DP::islessequal(a, b); }
  static inline bool gt(float a, float b) { return DP::isgreater(a, b); }
  static inline bool ge(float a, float b) { return DP::isgreaterequal(a, b); }
  static inline bool eq(float a, float b) { return DP::isequal(a, b); }
  static inline bool ne(float a, float b) { return DP::isnotequal(a, b); }

  static inline float exp(float a) { return DP::exp(a); }
  static inline float exp10(float a) { return DP::exp10(a); }
  static inline float log(float a) { return DP::log(a); }
  static inline float log10(float a) { return DP::log10(a); }
  static inline float log1p(float a) { return DP::log1p(a); }
  static inline float log2(float a) { return DP::log2(a); }
  static inline float expm1(float a) { return DP::expm1(a); }

  static inline float neg(float a) { return -a; }
  static inline float sin(float a) { return DP::sin(a); }
  static inline float cos(float a) { return DP::cos(a); }
  static inline float sqrt(float a) { return DP::sqrt(a); }
  static inline float rsqrt(float a) { return DP::rsqrt(a); }
  static inline float ceil(float a) { return DP::ceil(a); }
  static inline float floor(float a) { return DP::floor(a); }
  static inline float trunc(float a) { return DP::trunc(a); }

  static inline float acos(float a) { return DP::acos(a); }
  static inline float cosh(float a) { return DP::cosh(a); }
  static inline float asin(float a) { return DP::asin(a); }
  static inline float sinh(float a) { return DP::sinh(a); }
  static inline float tan(float a) { return DP::tan(a); }
  static inline float atan(float a) { return DP::atan(a); }
  static inline float tanh(float a) { return DP::tanh(a); }
  static inline float erf(float a) { return DP::erf(a); }
  static inline float erfc(float a) { return DP::erfc(a); }
  static inline float round(float a) { return DP::round(a); }

  static inline float frac(float a) {return a - DP::trunc(a);}
  ...
  static inline float pow  (float a, float b) { return DP::pow(a, b); }
  static inline float atan2(float a, float b) { return DP::atan2(a, b); }
  static inline float abs(float a) { return DP::fabs(a); }
...
struct Numerics<double> {
  ...
  static inline bool lt(double a, double b) { return DP::isless(a, b); }
  static inline bool le(double a, double b) { return DP::islessequal(a, b); }
  static inline bool gt(double a, double b) { return DP::isgreater(a, b); }
  static inline bool ge(double a, double b) { return DP::isgreaterequal(a, b); }
  static inline bool eq(double a, double b) { return DP::isequal(a, b); }
  static inline bool ne(double a, double b) { return DP::isnotequal(a, b); }

  static inline double exp(double a) { return DP::exp(a); }
  static inline double exp10(double a) { return DP::exp10(a); }
  static inline double log(double a) { return DP::log(a); }
  static inline double log10(double a) { return DP::log10(a); }
  static inline double log1p(double a) { return DP::log1p(a); }
  static inline double log2(double a) { return DP::log2(a); }
  static inline double expm1(double a) { return DP::expm1(a); }

  static inline double neg(double a) { return -a; }
  static inline double sin(double a) { return DP::sin(a); }
  static inline double cos(double a) { return DP::cos(a); }
  static inline double sqrt(double a) { return DP::sqrt(a); }
  static inline double rsqrt(double a) { return DP::rsqrt(a); }
  static inline double ceil(double a) { return DP::ceil(a); }
  static inline double floor(double a) { return DP::floor(a); }
  static inline double trunc(double a) { return DP::trunc(a); }
  static inline double acos(double a) { return DP::acos(a); }
  static inline double cosh(double a) { return DP::cosh(a); }
  static inline double asin(double a) { return DP::asin(a); }
  static inline double sinh(double a) { return DP::sinh(a); }
  static inline double tan(double a) { return DP::tan(a); }
  static inline double atan(double a) { return DP::atan(a); }
  static inline double tanh(double a) { return DP::tanh(a); }
  static inline double erf(double a) { return DP::erf(a); }
  static inline double erfc(double a) { return DP::erfc(a); }
  static inline double round(double a) { return DP::round(a); }

  static inline double frac(double a) {return a - DP::trunc(a);}
  ...
  static inline double pow  (double a, double b) { return DP::pow(a, b); }
  static inline double atan2(double a, double b) { return DP::atan2(a, b); }

  static inline double abs(double a) { return DP::fabs(a); }
