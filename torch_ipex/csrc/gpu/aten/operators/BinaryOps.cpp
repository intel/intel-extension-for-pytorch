...
Tensor add(const Tensor &self, Scalar other, Scalar alpha) {
  return at::AtenIpexTypeDPCPP::add(self, impl::wrapped_scalar_tensor(other),
                                    alpha);
}

Tensor &add_(Tensor &self, Scalar other, Scalar alpha) {
  return at::AtenIpexTypeDPCPP::add_(self, impl::wrapped_scalar_tensor(other),
                                     alpha);
}
...
Tensor sub(const Tensor &self, Scalar other, Scalar alpha) {
  return at::AtenIpexTypeDPCPP::sub(self, impl::wrapped_scalar_tensor(other),
                                    alpha);
}

Tensor &sub_(Tensor &self, Scalar other, Scalar alpha) {
  return at::AtenIpexTypeDPCPP::sub_(self, impl::wrapped_scalar_tensor(other),
                                     alpha);
}

Tensor rsub(const Tensor &self, Scalar other, Scalar alpha) {
  return at::AtenIpexTypeDPCPP::rsub(self, impl::wrapped_scalar_tensor(other),
                                     alpha);
}
...
Tensor &tanh_backward_out(Tensor &grad_input, const Tensor &grad_output,
                          const Tensor &output) {
