...
public:
  ...
  uint64_t pack() const noexcept { return stream_.pack(); }
...
CAFFE2_API DPCPPStream getDPCPPStreamFromPool(const bool isDefault = false,
...
CAFFE2_API DPCPPStream getDPCPPStreamOnDevice(DeviceIndex device_index,
                                              int stream_index);
...
namespace std {
template <> struct hash<at::dpcpp::DPCPPStream> {
