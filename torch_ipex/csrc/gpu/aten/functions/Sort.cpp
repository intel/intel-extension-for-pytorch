...
void SortKeyValueInplace(Tensor & key, Tensor & value, int dim, bool dir) {
  ...
  // size.
  int64_t ceilPowerOf2 = impl::nextHighestPowerOf2(keySliceSize);
...
template void SortKeyValueInplace<uint8_t>(Tensor & key, Tensor & value, int dim, bool dir);
template void SortKeyValueInplace<int8_t>(Tensor & key, Tensor & value, int dim, bool dir);
template void SortKeyValueInplace<double>(Tensor & key, Tensor & value, int dim, bool dir);
template void SortKeyValueInplace<float>(Tensor & key, Tensor & value, int dim, bool dir);
template void SortKeyValueInplace<int32_t>(Tensor & key, Tensor & value, int dim, bool dir);
template void SortKeyValueInplace<int64_t>(Tensor & key, Tensor & value, int dim, bool dir);
template void SortKeyValueInplace<int16_t>(Tensor & key, Tensor & value, int dim, bool dir);
