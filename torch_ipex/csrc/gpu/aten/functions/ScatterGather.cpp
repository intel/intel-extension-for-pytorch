...
void Gather(Tensor & tensor, const Tensor & src, int64_t dim, const Tensor & index) {
  TORCH_CHECK(TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(index)) == TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(src)),
      "Index tensor must have same dimensions as input tensor");
  TORCH_CHECK(TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(index)) == TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)),
      "Index tensor must have same dimensions as output tensor");
  TORCH_CHECK(dim >= 0 && dim < TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)),
      "Index dimension is out of bounds");
  TORCH_CHECK(TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(src)) == TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)),
      "Input tensor must have same dimensions as output tensor");

  for (int d = 0; d < TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)); d++) {
    if (d != dim) {
      TORCH_CHECK(TensorImpl_sizeLegacyNoScalars(TensorImpl_Unwrap(tensor), d) == TensorImpl_sizeLegacyNoScalars(TensorImpl_Unwrap(src), d),
  ...
  if (oldTensor.defined()) {
    ...
    // TODO:copyIgnoringOverlaps Called when we are copying into an overlapping index `dst`
  }
}
...
template <typename scalar_t>
void Scatter(Tensor & tensor, int64_t dim, const Tensor & index, const Tensor & src) {
  int index_ndim_legacy_all = TensorImpl_nDimensionLegacyAll(TensorImpl_Unwrap(index));
  TORCH_CHECK(dim >= 0 && dim < TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)),
      "Index dimension is out of bounds");
  TORCH_CHECK(index_ndim_legacy_all == 0
      || TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(index)) == TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(src)),
  ...
  for (int d = 0; d < TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)); d++) {
    int64_t indexSizeD = TensorImpl_sizeLegacyNoScalars(TensorImpl_Unwrap(index), d);
    if (d != dim) {
      TORCH_CHECK(indexSizeD <= TensorImpl_sizeLegacyNoScalars(TensorImpl_Unwrap(tensor), d),
                "Index tensor must not have larger size than output tensor apart from the specified dimension ",
                dim,
                ", but got index ",
                index.sizes(),
                " output ",
    ...
    TORCH_CHECK(indexSizeD <= TensorImpl_sizeLegacyNoScalars(TensorImpl_Unwrap(src), d),
              "Index tensor must not have larger size than input tensor, but got index ",
              index.sizes(),
              "input",
              src.sizes());
  }
...
template <typename scalar_t>
void ScatterFill(Tensor & tensor, int64_t dim, const Tensor & index, Scalar value_scalar) {

  int index_ndim_legacy_all = TensorImpl_nDimensionLegacyAll(TensorImpl_Unwrap(index));
  TORCH_CHECK(dim >= 0 && dim < TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)),
      "Index dimension is out of bounds");
  TORCH_CHECK(index_ndim_legacy_all == 0
      || TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(index)) == TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)),
...
ScatterAdd(Tensor & tensor, int64_t dim, const Tensor & index, const Tensor & src){
  int index_ndim_legacy_all = TensorImpl_nDimensionLegacyAll(TensorImpl_Unwrap(index));
  TORCH_CHECK(dim >= 0 && dim < TensorImpl_nDimensionLegacyNoScalars(TensorImpl_Unwrap(tensor)),
      "Index dimension is out of bounds");
  TORCH_CHECK(index_ndim_legacy_all == 0
...
Tensor & scatter_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & src) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Bool, self.scalar_type(), "Scatter", [&]() {
...
Tensor & scatter_(Tensor & self, int64_t dim, const Tensor & index, Scalar value) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Bool, self.scalar_type(), "ScatterFill", [&]() {
...
Tensor & scatter_add_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & src) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Bool, self.scalar_type(), "ScatterAdd", [&]() {
...
Tensor & gather_out(Tensor & out, const Tensor & self, int64_t dim, const Tensor & index, bool sparse_grad) {
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Bool, self.scalar_type(), "Gather", [&]() {
