...
if(CXX_AVX512_BF16_FOUND)
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_AVX512_CPU_BF16_DEFINITION")
  list(APPEND CPU_CAPABILITY_NAMES "AVX512_BF16")
  if(MSVC)
    list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG}/arch:AVX512") # TODO: CHECK HERE
  else(MSVC)
    list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -D__AVX512F__ -DCPU_AVX512 -DCPU_AVX512_BF16 -DCPU_CAPABILITY_AVX512
...
if(CXX_AVX512_FOUND)
  ...
  if(MSVC)
    ...
    list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -D__AVX512F__ -DCPU_AVX512 -mavx512f -mavx512bw -mavx512vl -mavx512dq -mfma")
  endif(MSVC)
