...
option(USE_CHANNELS_LAST_1D "Use channels last 1d. It is deprecated" ON)
...
option(USE_OVERRIDE_OP "Use the operator in IPEX to override the duplicated one in stock PyTorch" ON)
set(USE_AOT_DEVLIST "" CACHE STRING "Set device list for AOT build")
option(USE_DS_KERNELS "Build deepspeed kernels" ON)
option(USE_BNB_KERNELS "Build bitsandbytes kernels" ON)
if (WIN32 OR MSVC)
...
function (print_xpu_config_summary)
  ...
  if (USE_XETLA)
    ...
    message(STATUS "  USE_BNB_KERNELS       : ${USE_BNB_KERNELS}")
  ...
  message(STATUS "  USE_OVERRIDE_OP       : ${USE_OVERRIDE_OP}")
